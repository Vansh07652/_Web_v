---
id: physics-1-fluid-dynamics
title: "Fluid Dynamics"
slug: fluid-dynamics
subject: physics-1
subjectName: "Physics 1"
contentType: note
lesson: fluid-dynamics
lessonNumber: 13
description: "Study notes covering Fluid Dynamics." 
status: approved
...
sourceUrl:
originalFile: "data/source-provenance.json#source-8738db44342c4b70"
lastReviewed:
version: 1.0.0
---
...
| Dimensional test | $[volume flow rate] = [m^2] \cdot [m/s]$ | m^3/s | checking a derived or rearranged result |
...
Dimension check: m^2 x m/s reduces to m^3/s, matching volume flow rate
```

```text
PROBLEM: continuity flow rate example 2
System: one idealized system described by the chapter model
...
```text
PROBLEM: continuity flow rate example 3
System: one idealized system described by the chapter model
