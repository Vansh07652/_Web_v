---
id: genetics-introduction-to-genetics-and-history
title: "Introduction To Genetics And History"
slug: introduction-to-genetics-and-history
subject: genetics
subjectName: "Genetics"
contentType: note
lesson: introduction-to-genetics-and-history
lessonNumber: 1
description: "Study notes covering Introduction To Genetics And History." 
status: approved
...
sourceUrl:
originalFile: "data/source-provenance.json#source-538b20783233ae05"
lastReviewed:
version: 1.0.0
---
...
**Population genetics** studies allele frequencies in populations and how they change over time. Its baseline is the **Hardy Weinberg equilibrium**, in which no evolutionary forces act: allele frequencies satisfy $p + q = 1$ and genotype frequencies satisfy $p^2 + 2pq + q^2 = 1$.
