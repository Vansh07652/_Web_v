...
The **aromatic Claisen rearrangement** is the classic example: heating **allyl phenyl ether** gives **o-allylphenol** (the *ortho* product), because the enone-like intermediate tautomerizes to regenerate the aromatic ring. If both *ortho* positions are blocked, the *para* product forms via two consecutive [3,3] shifts (the allyl group first goes to the *ortho* position, then a second Cope-like rearrangement delivers it to *para*).

### The biological [1,7]-hydrogen shift: making vitamin D

Sunlight converts **7-dehydrocholesterol** (a steroid with a conjugated diene in ring B) into **previtamin D₃** by a photochemical electrocyclic ring opening (Topic 4's chemistry in action). Previtamin D₃ is not yet vitamin D: a thermal **[1,7]-hydrogen sigmatropic shift** moves a hydrogen across the seven-atom triene system, and a subsequent double-bond shift produces **vitamin D₃ (cholecalciferol)**. This is a genuine, well-studied example of a sigmatropic rearrangement running in human biochemistry.
...
|---|---|---|
| Cope rearrangement | [3,3] sigmatropic shift of a 1,5-diene to an isomeric 1,5-diene | Prototypical thermally allowed rearrangement; reversible, stereospecific |
| Claisen rearrangement | [3,3] shift of an allyl vinyl ether to a γ,δ-unsaturated carbonyl | Converts O–C to C–C bonds; cornerstone of synthesis |
| Oxy-Cope rearrangement | Cope variant with –OH on a terminus; gives an enol that tautomerizes | Irreversible and faster; synthetically more powerful |
| Aromatic Claisen rearrangement | Claisen shift of allyl phenyl ether, giving o- or p-allylphenol | Shows how aromaticity is regenerated after the shift |
| γ,δ-Unsaturated carbonyl | Carbonyl with a C=C three carbons away (counting the carbonyl carbon as 1) | The characteristic Claisen product; the double bond position is a diagnostic |
| Previtamin D₃ | Photochemical product of 7-dehydrocholesterol in skin | Undergoes a [1,7]-H sigmatropic shift to become vitamin D₃ |
...
3. Why is the oxy-Cope rearrangement irreversible while a simple Cope is often reversible?
...
1. The central C3–C4 σ bond of the 1,5-diene; the product retains the 1,5-diene functional group (an isomerization).
2. An allyl vinyl ether (O–C bond) becomes a γ,δ-unsaturated carbonyl compound (new C–C bond) — overall, an O–C to C–C bond conversion with a carbonyl formed by enol tautomerization.
3. The oxy-Cope gives an enol that tautomerizes to a much more stable carbonyl, making the overall process strongly exergonic; a simple Cope interconverts two similar 1,5-dienes and is nearly thermoneutral.
4. The first [3,3] shift delivers the allyl group to the ortho carbon; aromatization by tautomerization drives it. If both ortho positions are occupied, a second [3,3] shift moves the group to the para position.
5. Vitamin D₃ (cholecalciferol), formed by a thermal [1,7]-hydrogen sigmatropic shift.
6. Break the O–CH₂ bond; form a new C–C bond between the vinyl-ether terminal carbon and the allyl terminal carbon; shift the double bonds inward; tautomerize the enol to the aldehyde (pent-4-enal, CH₂=CH–CH₂–CH₂–CHO).

</details>

## Related Topics

- Previous: [Sigmatropic Rearrangements](07-sigmatropic-rearrangements.md)
- Next: [A Summary of Rules for Pericyclic Reactions](09-a-summary-of-rules-for-pericyclic-reactions.md)
- Related: [Photochemical Electrocyclic Reactions](04-photochemical-electrocyclic-reactions.md) (the ring opening that makes previtamin D), [Stereochemistry of Cycloadditions](06-stereochemistry-of-cycloadditions.md) (chair-like stereocontrol parallels), [Electrocyclic Reactions](02-electrocyclic-reactions.md)
...
- Content type: Original educational study guide based on OpenStax outline structure. The Cope and Claisen rearrangements, the oxy-Cope variant, the ortho/para selectivity of the aromatic Claisen, and the previtamin D₃ → vitamin D₃ [1,7]-H shift are standard textbook organic/biochemistry (the vitamin D pathway is described qualitatively; no clinical dosing claims are made).
- Lab safety note: none — these reactions are discussed as chemistry concepts; any laboratory work would require proper heat control, solvent handling, and PPE per institutional rules (general principles only).
