...
Evolution is one of the best-supported ideas in science, yet also one of the most misunderstood. Misconceptions persist because everyday language — words like "theory," "fittest," and "need" — clashes with precise scientific meanings. This topic clears up the most common errors: what "theory" really means, who evolves, whether evolution has a goal, what "fitness" means, and how fast evolution can happen.
...
In everyday speech, a "theory" is an unproven hunch. In science, a **theory** is a comprehensive, well-tested explanation supported by evidence from many independent lines of investigation. The theory of evolution by natural selection explains and connects observations from fossils, genetics, comparative anatomy, biogeography, and direct observation. The fact of evolution — genetic change over generations — is directly observed; the theory explains how and why.
...
Organisms do not evolve because they need something. Selection can only act on variation that already exists. If no giraffe has a mutation for a longer neck, no amount of "need" will produce one. Evolution is a blind, opportunistic process constrained by available variation.
...
|---|---|---|
| Theory (scientific) | A broad, well-tested explanation supported by extensive evidence | Distinguishes real science from guesses; "just a theory" is a category error |
| Evolution | Change in the genetic makeup of a population over generations | The core definition every misconception is checked against |
| Fitness | An individual's relative reproductive success | Corrects the myth that fitness means strength or survival |
| Natural selection | Non-random sorting of random variation | The main mechanism of adaptation; not random despite random mutations |
| Mutation | A random change in DNA creating new variation | The raw material selection acts on; random with respect to need |
| Common ancestor | A species from which two or more lineages descended | Explains human–ape relationships without "evolved from monkeys" errors |
| Acquired characteristic | A trait gained during an individual's lifetime | Lamarck's rejected idea; such traits are not inherited |
| Allele frequency | How common a gene version is within a population | The quantity that changes when a population evolves |

## Example: A "superbug" story in real time
...
1. No. Acquired characteristics are not inherited; this resembles Lamarck's rejected idea of inheritance of acquired characteristics.
2. Fitness is relative reproductive success — the alleles an individual passes to the next generation. Reproduction, not strength, is what matters, so a frail organism that leaves many offspring outcompetes a strong, sterile one.
3. Not entirely. Mutations arise randomly, but natural selection sorts that variation non-randomly, favoring traits that improve survival and reproduction.
4. Humans, chimpanzees, and bonobos share a common ancestor that lived millions of years ago; humans did not evolve from monkeys or any modern ape. Modern apes and monkeys are our evolutionary cousins, not our ancestors.
5. Antibiotic resistance in bacteria and pesticide resistance in insects; also measurable beak-size changes in Galápagos finches after droughts.
6. In science, a theory is a comprehensive, well-tested explanation supported by diverse evidence — not a guess. Evolution is both directly observed (genetic change in populations) and explained by a powerful theory.

</details>

## Related Topics

- Previous: [Speciation](04-speciation.md)
- Next: End of chapter
- Related: [Discovering How Populations Change](01-discovering-how-populations-change.md) · [Mechanisms of Evolution](02-mechanisms-of-evolution.md) · [Evidence of Evolution](03-evidence-of-evolution.md) · [Evolution and Its Processes chapter overview](../README.md)
