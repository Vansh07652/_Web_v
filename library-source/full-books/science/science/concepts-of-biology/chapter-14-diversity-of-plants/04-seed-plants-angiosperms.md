...
|---|---|---|
| Angiosperm | A seed plant with flowers; seeds enclosed in an ovary that becomes a fruit | The dominant, most diverse plant group and the source of most food crops |
| Flower | A modified reproductive shoot with sepals, petals, stamens, and carpels | Recruits pollinators and produces gametes, pollen, and seeds |
| Stamen | The male floral organ (anther + filament) that produces pollen | Supplies the male gametophyte (pollen) |
| Carpel | The female floral organ (stigma + style + ovary) that contains ovules | Site of ovule development; the ovary becomes the fruit |
| Ovary | The swollen base of a carpel that encloses the ovules | Distinguishes angiosperms; matures into the fruit |
| Pollination | Transfer of pollen from anther to stigma | The delivery step that precedes fertilization |
| Double fertilization | Two sperm fusions: zygote (2n) + endosperm (3n) | Unique angiosperm event; produces both embryo and food tissue |
| Endosperm | Triploid food-storing tissue that nourishes the embryo | The edible starch of grains; a key human food source |
| Fruit | The mature ovary, often with seeds inside | Protects seeds and aids dispersal by animals, wind, or other means |
| Cotyledon | Seed leaf; the first leaf-like structure of the embryo | One vs. two cotyledons is a classic monocot/eudicot distinction |
| Monocot | Angiosperm with one cotyledon, parallel veins, floral parts in 3s | Includes grasses, lilies, orchids, palms — including staple grains |
| Eudicot | Angiosperm with two cotyledons, netted veins, floral parts in 4s/5s | Includes most familiar broadleaf plants, trees, and crops |

## How It Works / Step-by-Step Process: from flower to fruit

1. A flower opens; a bee visits for nectar and picks up pollen from the anthers on its body.
2. The bee moves to another flower of the same species, and pollen grains stick to the sticky stigma (pollination).
3. A pollen grain germinates and grows a pollen tube down the style toward the ovule.
4. Two sperm travel through the tube into the embryo sac; one fertilizes the egg (zygote, 2n) and one fuses with the polar nuclei (endosperm, 3n) — double fertilization.
5. The zygote develops into an embryo; the ovule matures into a seed with its seed coat; the ovary wall thickens into a fruit.
6. The fruit ripens; an animal eats it and later deposits the seeds away from the parent plant.
7. A seed germinates, and the seedling — using food from the endosperm — grows into a new flowering plant.
...
1. What two structures define angiosperms and separate them from gymnosperms?
2. Describe double fertilization: which cells fuse, and what does each product become?
3. Why are bees considered essential to much of agriculture?
4. A pea pod, a tomato, and a dandelion "seed" head are all what, biologically?
5. Give four traits that usually distinguish a monocot from a eudicot.

<details>
<summary>Show answers</summary>

1. Flowers (the reproductive structures) and seeds enclosed in an ovary that matures into a fruit.
2. One sperm fuses with the egg to form the diploid zygote (→ embryo); a second sperm fuses with two polar nuclei to form the triploid endosperm (→ food tissue).
3. Bees transfer pollen between flowers, enabling pollination and fertilization in many crops; without pollinators, fruit and seed set falls sharply in animal-pollinated species.
4. Fruits — each is a mature ovary (or part of one) containing seeds, under the botanical definition.
5. One cotyledon, parallel leaf veins, flower parts in multiples of three, fibrous roots (and scattered vascular bundles); eudicots show two cotyledons, netted veins, parts in 4s or 5s, and a taproot.

</details>

## Related Topics

- Previous: [Seed Plants: Gymnosperms](03-seed-plants-gymnosperms.md)
- Next: End of chapter
- Related: [Diversity of Plants chapter overview](../README.md)
...
- Content type: Original educational study guide based on OpenStax outline structure. Species counts are commonly taught reference figures; verify current estimates against recent texts.
