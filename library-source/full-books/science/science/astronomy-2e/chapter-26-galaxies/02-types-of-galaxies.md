...
> **Chapter:** [Chapter 26: Galaxies](../README.md)  
> **Topic:** 2  
> **Source structure:** OpenStax public textbook outline

## Overview

Galaxies come in a small number of recognizable shapes, and those shapes tell a physical story. In 1926, Edwin Hubble sorted galaxy images into a scheme still used today — the "tuning fork" diagram: **elliptical** galaxies on the handle, **spirals** and **barred spirals** on the two tines, and **lenticular** galaxies at the fork. Outside the fork sit the **irregulars**, which refuse to fit any symmetric shape. This is a classification by appearance (morphology), but it is not merely cosmetic: a galaxy's shape correlates strongly with its gas content, stellar population, and star-formation activity. Ellipticals are smooth, red, and gas-poor; spirals are flat, blue-armed, and gas-rich; irregulars are patchy and actively forming stars.
...
Spirals are flattened disks of gas, dust, and stars with a central **bulge** and a surrounding halo. Their defining feature is the set of **spiral arms**, traced by young, blue stars, glowing clouds of ionized hydrogen (H II regions), and dark dust lanes — all signposts of active star formation. The arms are not solid objects; they are density waves that compress gas and trigger star formation as material flows through them (see Chapter 25's spiral-structure topic). Classification runs by bulge size and arm tightness: an **Sa** has a large bulge and tightly wound, smooth arms; an **Sc** has a small bulge and loose, clumpy arms. In a **barred spiral**, a bar of stars runs through the center, with arms emerging from the bar's ends. Our own Milky Way is a barred spiral. Spirals are rich in gas and continue forming stars today.
...
|---|---|---|
| Morphology | A galaxy's shape/appearance | The basis of Hubble's classification |
| Elliptical galaxy | Smooth, oval galaxy of old stars with little gas | Gas-poor end of the sequence; no current star formation |
| Spiral galaxy | Flat disk with arms, bulge, and halo; gas-rich | Star-forming galaxies like the Milky Way |
| Barred spiral | Spiral with a bar of stars through its center | The Milky Way is one; bars are common (SBa–SBc) |
| Lenticular (S0) | Disk + bulge, no arms, little gas | Transition class between ellipticals and spirals |
| Irregular galaxy | No symmetric shape; patchy, gas-rich | Common type, e.g., the Magellanic Clouds |
| H II region | Cloud of ionized hydrogen glowing around young hot stars | Tracer of active star formation in spiral arms |
| Dwarf galaxy | Small, faint galaxy (often elliptical or irregular) | The most numerous galaxy type in the universe |

## Example: Classifying Three Galaxies
...
1. Sketch the Hubble tuning fork from memory: where do ellipticals, spirals, barred spirals, and lenticulars go?
2. What does E7 tell you about an elliptical galaxy's shape?
3. A galaxy is smooth, red, and shows no star formation. What type is it most likely to be, and why?
4. What physical difference separates an Sa from an Sc spiral?
5. Why is it wrong to say the Hubble sequence shows how galaxies evolve?

<details>
<summary>Show answers</summary>

1. Ellipticals (E0–E7) on the handle, lenticulars (S0) at the fork, spirals (Sa–Sc) on one tine, barred spirals (SBa–SBc) on the other; irregulars don't fit on the diagram.
2. E7 is the most flattened elliptical (the number ≈ 10 × (1 − b/a); E7 corresponds to b/a ≈ 0.3). E0 is round.
3. An elliptical — smooth shape, red color, and no star formation indicate old stars and no gas, the hallmarks of ellipticals.
4. Bulge size and arm tightness: Sa has a large bulge and tightly wound, smooth arms; Sc has a small bulge and loose, clumpy arms.
5. The tuning fork is a morphological classification, not an evolutionary sequence. All galaxy types are about the same age; a galaxy's type reflects its formation history, gas supply, and environment, and galaxies can change type (e.g., through gas loss) in ways that don't follow the diagram's order.

</details>

## Related Topics

- Previous: [The Discovery of Galaxies](01-the-discovery-of-galaxies.md)
- Next: [Properties of Galaxies](03-properties-of-galaxies.md)
- Related: [The Extragalactic Distance Scale](04-the-extragalactic-distance-scale.md)
- Chapter overview: [Galaxies](../README.md)
...
- Numerical values (E-number formula, classifications) are commonly taught reference figures intended for learning; verify against current sources before citing in assessments.
