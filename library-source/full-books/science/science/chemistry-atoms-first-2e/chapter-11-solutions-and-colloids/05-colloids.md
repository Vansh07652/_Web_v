...
Colloids sit between solutions and suspensions. The dispersed particles are big enough to scatter light (the **Tyndall effect**) and to jiggle randomly (Brownian motion), but small enough that gravity cannot pull them down. Understanding what stabilizes a colloid — surface charge, adsorbed layers, and emulsifiers — explains why milk stays mixed, why mayonnaise doesn't separate, and why soap cleans grease. This topic covers the types of colloids, their characteristic properties, and how they are made and broken.
...
A colloid has two parts: a **dispersed phase** (the particles, 1–1000 nm) and a **dispersion medium** (the continuous phase that surrounds them). The key contrast:
...
- **Emulsifiers:** In emulsions, an **emulsifying agent** (like the casein in milk or lecithin in mayonnaise) coats droplets of one liquid so they cannot merge. Soap molecules have a water-loving head and an oil-loving tail — they surround grease droplets to form stable **micelles**, which is exactly how soap washes grease away.

### Making and breaking colloids

Colloids are made by **dispersion** (grinding or shaking large particles down to colloidal size, as in a colloid mill for paint) or by **condensation** (growing small particles, e.g., precipitation reactions). They are broken by **coagulation** — neutralizing the surface charge so particles clump and settle. Heating, adding electrolytes (like the salt that separates curds from whey in cheese-making), or adding an oppositely charged colloid (as in water treatment with alum) all cause coagulation.
...
|---|---|---|
| Colloid | Mixture with particles of 1–1000 nm dispersed in another phase. | Explains milk, fog, paint, blood, and countless everyday materials. |
| Dispersed phase | The particles distributed through a colloid. | Its identity and size determine the colloid type and behavior. |
| Dispersion medium | The continuous substance surrounding the dispersed particles. | Together with the dispersed phase, it names the colloid (foam, gel, sol...). |
| Tyndall effect | Scattering of light by colloidal particles, making a beam visible. | The classic test that distinguishes colloids from solutions. |
| Brownian motion | Random zigzag movement of colloidal particles from molecular collisions. | Keeps particles suspended; evidence of molecular motion. |
| Emulsion | Colloid of one liquid dispersed in another (milk, mayonnaise). | Central to food and cosmetic science. |
| Emulsifying agent | Substance that stabilizes an emulsion by coating droplets. | Casein in milk, lecithin in mayonnaise, soap micelles. |
| Micelle | Spherical cluster of soap/surfactant molecules trapping grease. | The mechanism of cleaning with soap and detergents. |
| Coagulation | Clumping of colloidal particles into larger, settling aggregates. | Used in water treatment and cheese-making; the reverse of stabilization. |

## Example: Distinguishing mixtures by particle behavior
...
1. A student shines a laser through salt water (no beam) and through diluted milk (visible beam). What do the results tell you?
2. Why don't colloidal particles settle out over time, even though they are denser than the medium?
3. List the three main mechanisms that keep colloids stable.
4. Milk is an emulsion of fat droplets in water. Why doesn't it separate into layers in the refrigerator?
5. How does adding salt to a colloid cause it to coagulate?
6. A muddy river is a suspension or a colloid? What evidence would settle the question?

<details>
<summary>Show answers</summary>

1. Salt water is a true solution (particles < 1 nm scatter no visible light); diluted milk is a colloid whose 1–1000 nm particles scatter light — the Tyndall effect.
2. Brownian motion: random collisions with solvent molecules constantly jostle the particles, counteracting gravity so they never settle.
3. Surface charge (like charges repel), adsorbed solvent/layer cushions, and emulsifying agents that coat droplets.
4. Casein and other milk proteins act as emulsifiers, coating fat droplets so they cannot coalesce into a floating layer.
5. The ions neutralize the surface charges on the particles; with repulsion gone, particles collide, clump, and settle (coagulation).
6. If it settles on standing, it's a suspension; if it stays cloudy and shows a Tyndall beam, it's a colloid. (Rivers are typically suspensions of larger sediment plus colloidal clay.)

</details>

## Related Topics

- Previous: [Colligative Properties](04-colligative-properties.md)
- Next: End of chapter
...
- Content type: Original educational study guide based on OpenStax outline structure. Colloidal particle-size ranges (1–1000 nm) follow standard reference values; all examples are original explanatory scenarios.
