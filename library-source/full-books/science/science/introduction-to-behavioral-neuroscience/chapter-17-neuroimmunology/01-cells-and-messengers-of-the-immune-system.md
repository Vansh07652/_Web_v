---
title: "Cells and Messengers of the Immune System"
subject: "Science"
...
> **Chapter:** [Chapter 17: Neuroimmunology](../README.md)  
> **Topic:** 1  
...
Immunity is organized into two cooperating arms. **Innate immunity** is the fast, first-line response: present from birth, broad (pattern recognition, not precise memory), acting within minutes to hours — its cells include **macrophages, neutrophils, dendritic cells, and natural killer (NK) cells**, supported by soluble proteins such as **complement**. **Adaptive immunity** is slower but specific and remembers: it takes days to build on first exposure, uses **B lymphocytes (B cells)** and **T lymphocytes (T cells)** with receptors tailored to particular molecular shapes (antigens), and produces long-lived **memory cells** for faster second responses.
...
- **Microglia are immune cells in the brain.** The brain has its own resident innate immune cells (microglia), so the immune vocabulary applies inside the skull, not just in the blood.
- **Innate vs. adaptive is an exam staple.** Distinguishing speed, specificity, and memory cleanly predicts most immune questions.
- **Clinical relevance:** vaccines exploit adaptive memory; chronic inflammatory diseases reflect cytokine signaling gone wrong; immunosuppression (e.g., glucocorticoids) targets these cells and messengers.
...
|---|---|---|
| Innate immunity | Fast, broad, memory-less first-line defense | Acts within minutes; recognizes classes of pathogens |
| Adaptive immunity | Slow, specific, memorable defense by lymphocytes | Provides lasting, tailored protection (vaccines work here) |
| Macrophage | Large phagocytic cell that eats pathogens and presents antigen | Tissue workhorse of innate defense and APC |
| Neutrophil | Most abundant white blood cell; rapid phagocyte | First cell type to flood infection sites |
| Dendritic cell | Professional antigen-presenting cell | Bridges innate and adaptive immunity |
| Natural killer (NK) cell | Lymphocyte that kills infected cells without prior exposure | Early antiviral/antitumor defense |
| B cell / plasma cell | Lymphocyte that becomes an antibody factory | Source of antibodies (IgG, IgA, IgM, IgE, IgD) |
| Helper T cell (CD4+) | Lymphocyte that coordinates the immune response via cytokines | Master regulator; HIV targets these cells |
| Cytotoxic T cell (CD8+) | Lymphocyte that kills infected cells | Direct cell-killing arm of adaptive immunity |
| PAMP / PRR | Pathogen molecular signature / its detector (e.g., TLR) | How innate cells recognize "not self" |
| MHC class I / II | Molecules that display antigen fragments to CD8+ / CD4+ T cells | Defines what each T cell type can "see" |
| Cytokine | Small secreted signaling protein between immune cells | The messengers that also reach the brain |
| Interferon | Antiviral cytokine (IFN-α/β/γ) | Blocks viral spread; causes flu-like malaise |
| Chemokine | Cytokine that guides cell movement | Directs leukocytes to infection sites |
| Complement | Cascade of plasma proteins that tag, lyse, and attract | Soluble innate effector system |
| Microglia | Resident immune cells of the central nervous system | The brain's innate immune sentinels |

## Example: A Splinter Under the Skin
...
1. List the four main innate immune cell types and their basic jobs.
2. What do TLRs detect, and why is that detection "broad" rather than specific?
3. What is the role of dendritic cells in connecting innate and adaptive immunity?
4. How do CD4+ and CD8+ T cells differ in what they recognize and what they do?
5. Name three cytokine families and give one job of each.
6. Why does a second encounter with the same pathogen produce a faster, stronger response?

<details>
<summary>Show answers</summary>

1. Macrophages (phagocytosis, cytokines, antigen presentation), neutrophils (rapid phagocytosis), dendritic cells (antigen presentation to T cells), NK cells (killing infected cells without prior sensitization).
2. TLRs detect PAMPs — conserved molecular signatures like lipopolysaccharide or viral RNA. They recognize classes of microbes, not individual strains, so the response is broad.
3. Dendritic cells capture pathogen, process it, and present peptide fragments on MHC molecules to T cells in lymph nodes, activating the adaptive response with costimulation.
4. CD4+ helper T cells recognize antigen on MHC class II and coordinate via cytokines; CD8+ cytotoxic T cells recognize antigen on MHC class I and kill infected cells directly.
5. Interleukins (e.g., IL-1, IL-6 — cell-to-cell signaling/inflammation), TNF-α (inflammation), interferons (antiviral defense), chemokines (direct cell migration).
6. Because the first infection generates long-lived memory B and T cells that recognize the same antigen, so clonal expansion is faster and antibody production larger (the basis of vaccination).
...
- Next: [What Does Your Immune System Have to Do with Your Behavior?](02-what-does-your-immune-system-have-to-do-with-your-behavior.md)
- Related: [How Does the Brain Talk to the Immune System?](03-how-does-the-brain-talk-to-the-immune-system.md)
- Related: [What Do Immune System Signals Do Once They Reach the Brain?](04-what-do-immune-system-signals-do-once-they-reach-the-brain.md)
- Related: [Chapter 16: Homeostasis](../chapter-16-homeostasis/README.md) — fever and immune signaling tie into homeostatic control
- Related: [Neuroimmunology chapter overview](../README.md)
...
- Content type: Original educational study guide based on OpenStax outline structure. Cell proportions and cytokine descriptions are commonly taught reference concepts and should be verified against current texts.
