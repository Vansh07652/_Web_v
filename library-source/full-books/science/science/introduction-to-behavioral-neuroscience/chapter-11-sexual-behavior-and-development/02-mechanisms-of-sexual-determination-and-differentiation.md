---
title: "Mechanisms of Sexual Determination and Differentiation"
subject: "Science"
...
|---|---|---|
| SRY | Sex-determining gene on the Y chromosome; a transcription factor | The trigger that pushes the bipotential gonad toward testes |
| Bipotential gonad | Embryonic gonad that can become ovary or testis | Where genetic sex becomes gonadal sex |
| Sertoli cells | Testicular supporting cells that make AMH | Their AMH deletes the female internal ducts |
| Leydig cells | Testicular cells that produce testosterone | Supply the male hormonal signal |
| Müllerian ducts | Embryonic ducts that become uterus, fallopian tubes, upper vagina | Regress in males via AMH |
| Wolffian ducts | Embryonic ducts that become epididymis, vas deferens, seminal vesicles | Persist only with testosterone support |
| AMH (anti-Müllerian hormone) | Sertoli-cell hormone that causes Müllerian duct regression | The male "delete" signal |
| DHT (dihydrotestosterone) | Potent androgen made from testosterone in target tissues | Drives male external genitalia |
| Organizational effect | Permanent, early hormone action that builds neural structure | Explains critical-period brain masculinization |
| Activational effect | Temporary, later hormone action on organized circuits | Explains puberty and adult hormone effects |
| Aromatase | Enzyme converting testosterone to estradiol | Central to the aromatization hypothesis |

## Example: The Two-Hormone Trick of a Developing Male
...
|---|---|---|
| Sex determination | Sex differentiation | Determination is the genetic decision (SRY); differentiation is the developmental cascade that follows |
| Testosterone | DHT | DHT is made from testosterone in target tissues; it is the main driver of external genital development |
| AMH | Testosterone | Both come from the testis but differ: AMH deletes Müllerian ducts; testosterone supports Wolffian ducts |
| Organizational effects | Activational effects | Organizational = early, permanent, structural; activational = later, temporary, functional |
| "Default female" | Passive female development | The ovarian pathway is actively promoted by genes (e.g., WNT4, DAX1); "default" is a simplification |
| Chromosomes | Phenotype | Chromosomes set the first step, but hormones and receptors build the body; AIS and CAH show this |
...
1. SRY encodes a transcription factor directing the bipotential gonad to become testes; without functional SRY, the gonad follows the ovarian pathway.
2. Müllerian and Wolffian ducts. Testosterone supports Wolffian ducts (epididymis, vas deferens, seminal vesicles); AMH deletes the Müllerian system.
3. Organizational: early, permanent structural change (testosterone in the rodent critical period enlarges brain nuclei). Activational: later, reversible modulation (adult testosterone increasing mating behavior).
4. That much of testosterone's masculinizing action in the rodent brain occurs after aromatase converts it to estradiol — local estrogen does the organizing.
5. The testes make testosterone, but nonfunctional androgen receptors mean tissues cannot respond; without effective androgen signaling, external genitalia develop along the female-typical pathway.
6. Because the ovarian pathway is actively promoted by genes such as WNT4 and DAX1 — female development is not a passive fallback but an actively maintained program.
</details>

## Related Topics

- [Understanding Sexual Reproduction and Sexual Dimorphism](01-understanding-sexual-reproduction-and-sexual-dimorphism.md) — gametes, meiosis, and what dimorphism means before the cascade starts
- [Sex Differences in Brain and Behavior: Genetic, Hormonal, and Environmental Mechanisms](03-sex-differences-in-brain-and-behavior-genetic-hormonal-and-environmental-mechanisms.md) — how the hormones from this cascade produce brain and behavior differences
- [Sex Differences in Brain Circuits and Susceptibility to Psychiatric Disease](04-sex-differences-in-brain-circuits-and-susceptibility-to-psychiatric-disease.md) — where sex-biased disease risk comes from
- [Chapter 11: Sexual Behavior and Development](../README.md) — chapter overview and topic list
