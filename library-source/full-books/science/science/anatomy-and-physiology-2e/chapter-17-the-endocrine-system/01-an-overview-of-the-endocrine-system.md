...
Endocrine disorders are common, recognizable, and often treatable: diabetes involves the pancreatic hormones insulin and glucagon; thyroid disease involves too much or too little thyroid hormone; adrenal problems alter cortisol and aldosterone; growth and puberty depend on pituitary and gonadal hormones. Understanding the system's basic design explains everyday clinical observations. A "low hormone" level can mean the gland itself has failed, or that the gland that controls it (the pituitary or hypothalamus) has failed — the same lab result, two different causes. Understanding feedback also explains why treating one hormone can suppress the body's own production of it. For nursing and health careers, the endocrine system is also where patients most often ask "why": why insulin is injected, why thyroid pills must be taken the same way every day, why stress raises blood sugar. This overview gives you the map; the rest of the chapter fills in the territory.
...
Many anterior pituitary hormones are **tropic hormones**: their main job is to turn on another endocrine gland. TSH stimulates the thyroid, ACTH stimulates the adrenal cortex, and FSH and LH stimulate the gonads. This creates the classic cascade: hypothalamus → pituitary → target gland → hormone → tissues.
...
Most endocrine loops use **negative feedback**: the product of a loop inhibits further release, which keeps levels stable in a range (homeostasis). Example: as thyroid hormone in the blood rises, it suppresses TSH release from the pituitary, so the thyroid slows down. This is the same logic as a thermostat.

Some loops use **positive feedback**, where the response amplifies the original stimulus to drive a process to completion. Commonly taught examples are oxytocin during childbirth (uterine contractions stimulate more oxytocin release, producing stronger contractions until delivery) and oxytocin during milk ejection. Blood clotting is another classic example.

The body regulates around **set points** — reference levels for things like blood glucose and blood calcium. When a level drifts away from the set point, corrective hormone loops push it back.
...
|---|---|---|
| hormone | A chemical messenger released into the blood | The signal molecule of the endocrine system |
| endocrine gland | A ductless gland that secretes hormones into the blood | The core structure of the system |
| exocrine gland | A gland that secretes through a duct onto a surface | The contrast that defines "endocrine" |
| target cell | A cell that has receptors for a given hormone | Only target cells respond to a hormone |
| tropic hormone | A hormone that stimulates another endocrine gland | How the pituitary controls the rest of the system |
| negative feedback | A response that reduces the original stimulus | Keeps hormone levels stable |
| positive feedback | A response that amplifies the original stimulus | Drives processes to completion (labor, milk ejection) |
| set point | A reference level the body regulates around | The target of most feedback loops |
| homeostasis | Stable internal conditions | The goal of most endocrine regulation |

## How It Works / Step-by-Step Process

1. A stimulus changes an internal condition — for example, blood glucose rises after a meal.
2. Endocrine cells detect the change and release hormone(s) into the blood.
3. The hormone travels through the blood to its target cells and binds their receptors.
4. Target cells change their activity — taking up glucose, releasing stored glucose, adjusting kidney function, and so on.
5. The change feeds back to the source: negative feedback reduces the original signal; positive feedback amplifies it.
6. The system settles at a new steady state near the set point.
...
1. What is the difference between an endocrine gland and an exocrine gland?
2. Give one example each of negative feedback and positive feedback.
3. Why is "master gland" an incomplete nickname for the pituitary?
4. Which organ links the nervous system and the endocrine system?
5. Why can one hormone produce different effects in different tissues?
6. Which organ is both exocrine and endocrine?

<details>
<summary>Show answers</summary>

1. Endocrine glands are ductless and secrete hormones into the blood; exocrine glands secrete through ducts onto a surface (skin, gut, etc.).
2. Negative feedback: rising thyroid hormone suppresses TSH, or insulin lowering blood glucose. Positive feedback: oxytocin and uterine contractions during labor, or oxytocin and milk ejection.
3. Because the hypothalamus controls the pituitary — the pituitary is a powerful relay, but it takes orders from the hypothalamus.
4. The hypothalamus — it receives neural input and controls the anterior and posterior pituitary.
5. Because the response depends on the receptors and machinery of each target cell, not just on the hormone molecule itself.
6. The pancreas — exocrine acinar cells make digestive enzymes, while the islets of Langerhans make insulin and glucagon.
...
- Next: [Hormones](02-hormones.md)
- Related: [The Pituitary Gland and Hypothalamus](03-the-pituitary-gland-and-hypothalamus.md), [The Thyroid Gland](04-the-thyroid-gland.md), [The Adrenal Glands](06-the-adrenal-glands.md), [The Endocrine Pancreas](09-the-endocrine-pancreas.md), [The Endocrine System chapter overview](../README.md)
...
- Content note: Gland lists, feedback examples, and hormone functions are commonly taught reference concepts; verify specifics against current texts. Educational study material only.
