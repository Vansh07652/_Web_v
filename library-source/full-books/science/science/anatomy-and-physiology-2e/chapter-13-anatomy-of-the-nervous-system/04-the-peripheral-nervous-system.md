...
> **Chapter:** [Chapter 13: Anatomy of the Nervous System](../README.md)  
> **Topic:** 4  
...
Peripheral nerve anatomy is everyday clinical vocabulary. When a patient reports numbness in the thumb and index finger, the examiner must decide between a compressed median nerve at the wrist (carpal tunnel) and an irritated C6 nerve root in the neck — a distinction that depends on knowing which spinal nerve supplies which skin. Dermatome maps localize spinal cord injuries and track conditions like shingles; reflex testing, which uses PNS pathways, is part of every neurological exam. Peripheral neuropathies (a common complication of diabetes) and traumatic nerve injuries are managed using these principles. Exams routinely test nerve counts, root levels, plexus composition, and the sensory-versus-motor root distinction.

## Core Concepts

### Nerves and ganglia: the building blocks

A nerve is a bundle of axons in the PNS wrapped in connective tissue: the endoneurium around each axon, the perineurium around each bundle (fascicle), and the epineurium around the whole nerve. Most spinal nerves are mixed, carrying both sensory and motor fibers. A ganglion is a cluster of neuron cell bodies outside the CNS: sensory ganglia (the dorsal root ganglia) hold sensory cell bodies, and autonomic ganglia hold autonomic motor cell bodies. The same cluster inside the CNS is called a nucleus, not a ganglion.
...
|---|---|---|
| Nerve | A bundle of axons in the PNS wrapped in connective tissue | The "wires" carrying signals between CNS and body |
| Ganglion | Cluster of neuron cell bodies outside the CNS | Dorsal root ganglia hold sensory cell bodies; autonomic ganglia hold motor ones |
| Afferent / efferent | Toward the CNS / away from the CNS | Afferent = sensory input; efferent = motor output |
| Dorsal root / ventral root | Sensory root in / motor root out | Root damage causes sensory loss (dorsal) or weakness (ventral) |
| Plexus | Network of interwoven spinal nerve branches | Reorganizes root fibers into named limb nerves |
| Dermatome | Skin area supplied by one spinal nerve | Used to localize spinal cord/root lesions |
| Cranial nerve | One of 12 nerve pairs attached to the brain | Innervate the head, neck, and viscera |
| Cauda equina | Bundle of lumbar/sacral roots below the spinal cord | Low spinal injuries can compress multiple roots here |

## Example / Clinical Reasoning Walkthrough
...
1. How many pairs of cranial and spinal nerves does the adult human typically have, and how are the spinal nerves distributed by region?
2. A patient loses sensation over a patch of skin but keeps full muscle strength there. Which root is more likely damaged, and why?
3. Why does losing a single nerve root rarely cause complete numbness in a dermatome?
4. Where do the sensory cell bodies for spinal nerves sit?
5. A nerve in the arm is crushed but the cell bodies survive. What happens to the axon distal to the injury, and what roughly guides recovery time?

<details>
<summary>Show answers</summary>

1. 12 pairs of cranial nerves and 31 pairs of spinal nerves (8 cervical, 12 thoracic, 5 lumbar, 5 sacral, 1 coccygeal).
2. The dorsal (sensory) root — it carries incoming sensory fibers, while the ventral root carries motor fibers.
3. Dermatomes overlap: adjacent spinal nerves share skin territory, so neighboring roots compensate for the lost input.
4. In the dorsal root ganglion, just outside the spinal cord on the dorsal root.
5. The distal segment degenerates (Wallerian degeneration); the axon regrows through its connective tissue tube at roughly 1 mm per day, so recovery time is estimated from the injury site to the target.

</details>

## Related Topics

- Previous: [Circulation and the Central Nervous System](03-circulation-and-the-central-nervous-system.md)
- Related: [The Embryologic Perspective](01-the-embryologic-perspective.md), [The Central Nervous System](02-the-central-nervous-system.md)
- Next chapter: [Chapter 14: The Somatic Nervous System](../chapter-14-the-somatic-nervous-system/README.md)
- Chapter overview: [Anatomy of the Nervous System](../README.md)
...
- Safety note: Educational content only. Regeneration rates and segment counts are commonly taught reference concepts — verify against current texts before clinical use.
