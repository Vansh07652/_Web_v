...
> **Chapter:** [Chapter 25: The Urinary System](../README.md)  
> **Topic:** 4  
> **Source structure:** OpenStax public textbook outline

## Overview

Gross anatomy provides the map, but the real work happens in the **nephron**, the kidney's functional unit — roughly one million per kidney (commonly taught). Each nephron has two parts: the **renal corpuscle**, a high-pressure filter, and the **renal tubule**, a long processing pipe whose segments have distinctive cells and jobs. Filtrate moves through the proximal convoluted tubule (PCT), loop of Henle, and distal convoluted tubule (DCT), then into a collecting duct shared by many nephrons. Where the DCT touches its own afferent arteriole, the **juxtaglomerular apparatus** senses the fluid and helps regulate blood pressure. Knowing which cell type lives where explains why different diseases damage different regions, why certain drugs act on certain segments, and why a biopsy report reads as it does.

## Why This Matters

Microscopic anatomy is where physiology and pharmacology become visible. Each tubule segment carries specific transporters — which is why loop diuretics act on the thick ascending limb while thiazides act on the DCT (commonly taught). Disease patterns follow the cells: podocyte damage lets protein into the urine (nephrotic pattern); tubule-cell injury is the pattern in acute tubular injury. The juxtaglomerular apparatus links the kidney to blood-pressure regulation via renin, central to hypertension teaching. On exams, histology questions often hinge on one clue — a bright brush border means PCT; a macula densa means a DCT near its glomerulus. And the two nephron types explain why only some nephrons can concentrate urine.

## Core Concepts

### The renal corpuscle: a pressurized filter

The renal corpuscle consists of the **glomerulus** — a tuft of fenestrated capillaries — wrapped in **Bowman's capsule**. Blood enters via the afferent arteriole and leaves via the smaller efferent arteriole; this difference helps maintain high pressure inside the tuft (commonly taught). The capsule's visceral layer is made of **podocytes**, cells with finger-like foot processes; gaps between them form **filtration slits** bridged by slit diaphragms. Between the capillaries sit **mesangial cells**, which contract, clear debris, and regulate flow. The three-layer **filtration membrane** — fenestrated endothelium, basement membrane, filtration slits — blocks blood cells and almost all plasma proteins while letting water, ions, and small solutes through. 
...
**Loop of Henle.** The thin descending limb is permeable to water but not solutes, so water leaves and the filtrate concentrates; the ascending limb is impermeable to water, and its thick portion transports Na⁺, K⁺, and Cl⁻ out via the Na-K-2Cl cotransporter (NKCC2), diluting the fluid and building the medullary salt gradient.

**Distal convoluted tubule (DCT).** Cuboidal cells with few microvilli; reabsorbs Na⁺ and Cl⁻ (Na-Cl cotransporter, NCC) and Ca²⁺ under parathyroid hormone (PTH).
...
About 85% are **cortical nephrons**: corpuscles in the outer cortex, short loops of Henle, wrapped in peritubular capillaries. About 15% are **juxtamedullary nephrons**: corpuscles near the corticomedullary junction, loops plunging deep into the medulla, with **vasa recta** — straight vessels — running alongside. The long loops plus vasa recta are essential for building and preserving the medullary concentration gradient that allows the kidney to produce concentrated urine.
...
|---|---|---|
| Nephron | The kidney's functional unit: corpuscle + tubule | Everything the kidney does happens here |
| Renal corpuscle | Glomerulus plus Bowman's capsule | The filtration site |
| Glomerulus | Tuft of fenestrated capillaries | High-pressure blood filter |
| Bowman's capsule | Cup that surrounds the glomerulus | Collects the filtrate |
| Podocyte | Cell with foot processes on the capsule's visceral layer | Its slits form part of the filtration barrier |
| Filtration slit | Gap between podocyte foot processes | Where protein leakage occurs when damaged |
| Brush border | Microvilli on PCT cells | Maximizes surface area for reabsorption |
| NKCC2 | Na-K-2Cl cotransporter in the thick ascending limb | Loop-diuretic target; builds the salt gradient |
| NCC | Na-Cl cotransporter in the DCT | Thiazide-diuretic target |
| Principal cell | Collecting-duct cell responding to aldosterone and ADH | Final tuning of Na⁺, K⁺, and water |
| Juxtaglomerular apparatus | JG cells + macula densa + extraglomerular mesangial cells | Renin release and tubuloglomerular feedback |
| Macula densa | NaCl-sensing cells of the DCT | Tells the arteriole to constrict or dilate |
| Vasa recta | Straight vessels beside juxtamedullary loops | Preserve the medullary gradient |
...
|---|---|---|
| PCT | DCT (on histology) | PCT: brush border + abundant mitochondria; DCT: smooth border, fewer organelles. |
| Filtration slits | Fenestrations | Slits are gaps between podocyte foot processes; fenestrations are pores in the capillary endothelium. |
| Collecting duct as part of the nephron | Nephron proper | The nephron proper usually ends at the DCT; collecting ducts drain many nephrons. |
| Cortical nephron | Juxtamedullary nephron | Cortical = short loop, no vasa recta; juxtamedullary = long loop + vasa recta, needed for concentration. |
| JG cells | Macula densa | JG cells: afferent arteriole, secrete renin. Macula densa: DCT, senses NaCl. |
| Glomerulus | Bowman's capsule | Tuft of capillaries versus the cup around it. |
...
1. Fenestrated endothelium → basement membrane → podocyte filtration slits.
2. The PCT. The brush border (microvilli) maximizes surface area for the PCT's massive reabsorption.
3. In the thick ascending limb. That segment is impermeable to water, so NKCC2 moves salt out without water — diluting the filtrate and building the medullary salt gradient.
4. Principal cells. Aldosterone increases Na⁺ reabsorption (and K⁺ secretion); ADH inserts aquaporin-2 channels, increasing water reabsorption.
5. The macula densa detects NaCl in the tubular fluid. When NaCl delivery is low, it signals the afferent arteriole to dilate (raising GFR) and JG cells to release renin.
6. Their long loops and associated vasa recta build and preserve the medullary gradient that collecting ducts use to reabsorb water.

</details>

## Related Topics

- Previous: [Gross Anatomy of the Kidney](03-gross-anatomy-of-the-kidney.md)
- Next: [Physiology of Urine Formation](05-physiology-of-urine-formation.md)
- Related: [The Urinary System chapter overview](../README.md)
