...
> **Chapter:** [Chapter 33: The Immune System](../README.md)  
> **Topic:** 4  
...
- **Too little immunity (immunodeficiency):** the system cannot mount an adequate response, so infections become frequent, severe, or opportunistic.
- **Misdirected or excessive immunity (hypersensitivity and autoimmunity):** the system responds destructively to harmless substances (allergy) or attacks the body's own tissues (autoimmunity).
...
|---|---|---|
| Immunodeficiency | Inability of the immune system to respond adequately to infection | Explains vulnerability to opportunistic infections; primary (genetic) vs secondary (acquired, e.g., HIV) |
| Primary vs secondary immunodeficiency | Present from birth (genetic) vs acquired later in life | Determines cause, timing, and which populations are affected |
| CD4+ helper T cell | The T cell that coordinates the adaptive response | The main target of HIV; its loss collapses the whole specific defense |
| Allergen | A normally harmless antigen that triggers an allergic response | The trigger of type I hypersensitivity |
| Histamine | A mediator released by mast cells that causes itching, swelling, and airway narrowing | The cause of allergy symptoms; target of antihistamine drugs |
| Anaphylaxis | A rapid, systemic, potentially life-threatening allergic reaction | The most severe allergic emergency |
| Self-tolerance | The ability of the immune system to ignore the body's own molecules | Its failure produces autoimmune disease |
| Autoimmunity | Immune attack on the body's own tissues | Underlies type 1 diabetes, RA, MS, lupus |
| MHC (HLA) molecules | Cell-surface proteins that display "self" identity | The molecular basis of transplant rejection and tissue typing |
| Graft rejection | Immune destruction of transplanted tissue | Why transplants need immunosuppression and tissue matching |
...
|---|---|---|
| Immunodeficiency | Autoimmunity | Immunodeficiency = too *little* immune activity; autoimmunity = immune activity aimed at *self*. Opposite directions of failure |
| Allergy | Autoimmunity | Allergy attacks a harmless *environmental* antigen (pollen, food); autoimmunity attacks the body's *own* molecules |
| Anaphylaxis | A mild allergy | Same mechanism (IgE–mast cell), different scale; anaphylaxis is systemic and life-threatening |
| Type I hypersensitivity | Type IV | Type I is IgE/mast-cell mediated and fast (minutes); type IV is T-cell mediated and delayed (hours to days) |
| Primary immunodeficiency | Secondary | Primary = genetic, from birth; secondary = acquired later (HIV, chemo, malnutrition) |
| The hygiene hypothesis | Established fact | It is a hypothesis with correlational support and mixed evidence — flag it as such on exams |
| Immunosuppression after transplant | A cure for rejection | Drugs reduce rejection but cause a state of immunodeficiency — a trade-off, not a fix |
...
1. Immunodeficiency (too little immunity), hypersensitivity (excessive or misdirected response to harmless substances), and autoimmunity (attack on self). Transplant rejection is a normal response to a medical intervention, not a failure of the system itself.
2. Helper T cells are the coordinators of the adaptive response: they activate B cells for antibody production and activate cytotoxic T cells for cell-mediated killing. Without them, neither arm can be triggered effectively.
3. First exposure primes the system: B cells produce allergen-specific IgE that coats mast cells. On re-exposure, the allergen cross-links the IgE on mast cells, triggering degranulation and release of histamine and other mediators, producing itching, swelling, and airway narrowing within minutes.
4. Self-tolerance is the immune system's ability to ignore the body's own molecules, established by negative selection in the thymus and reinforced by peripheral mechanisms. When it fails, the adaptive response attacks self-tissue — autoimmunity (e.g., type 1 diabetes, RA, MS).
5. T cells recognize the donor's foreign MHC molecules and would attack the graft. Immunosuppressive drugs suppress that response but also suppress protective immunity, raising the risk of infection — and the drugs must be taken for life.
</details>
...
- Next: End of chapter
- Related: [Innate Immune Response](01-innate-immune-response.md) · [Adaptive Immune Response](02-adaptive-immune-response.md) · [The Immune System chapter overview](../README.md)
