...
**Meiosis** is the two-part cell division that produces **haploid** gametes — sperm and egg cells — each carrying half the chromosome number of the parent. Where mitosis makes two genetically identical diploid cells, meiosis makes **four genetically distinct haploid cells**, and it does so through two sequential divisions: **meiosis I**, which separates **homologous chromosomes** (the reductional division), and **meiosis II**, which separates **sister chromatids** (the equational division, superficially like mitosis). Two signature events in prophase I make meiosis genetically transformative: **synapsis**, in which each pair of homologous chromosomes zips together into a **tetrad**, and **crossing over**, in which nonsister chromatids physically exchange segments at points called **chiasmata**. Combined with **independent assortment** — the random orientation of each tetrad at the metaphase plate — meiosis produces gametes whose genetic combinations differ from the parent's and from each other's. When a haploid sperm fertilizes a haploid egg, the diploid chromosome number is restored in the zygote, and the offspring's genome is a fresh mix of both parents' chromosomes.
...
- **Chromosome errors:** When meiosis goes wrong, **nondisjunction** produces gametes with the wrong chromosome number, which can lead to conditions such as trisomy 21 (Down syndrome — commonly taught; person-first language: "people with Down syndrome"). This topic sets up Chapter 13's chromosomal disorders.
...
|---|---|---|
| Meiosis | Two-part division producing four haploid, genetically distinct cells. | The basis of gamete production and genetic variation. |
| Homologous chromosomes | A matched pair of chromosomes — one from each parent — carrying the same genes. | Their separation in meiosis I is what halves the chromosome number. |
| Haploid (n) | Having one set of chromosomes (one copy of each chromosome). | The state of gametes; restores diploidy at fertilization. |
| Diploid (2n) | Having two sets of chromosomes (homologous pairs). | The state of body cells; humans: 46 chromosomes (23 pairs). |
| Synapsis | The pairing of homologous chromosomes in prophase I. | Creates the tetrad, the structure in which crossing over happens. |
| Tetrad | Four chromatids: a pair of homologous chromosomes, each duplicated. | The functional unit aligned at metaphase I. |
| Crossing over | Exchange of segments between nonsister chromatids in prophase I. | Recombines alleles — a major source of genetic variation. |
| Chiasma (pl. chiasmata) | The visible crossover point between chromatids. | Evidence that recombination occurred; holds homologs together. |
| Independent assortment | Random orientation of tetrads at metaphase I. | Shuffles maternal/paternal chromosomes into gametes. |
| Nondisjunction | Failure of chromosomes to separate properly in meiosis. | Produces gametes with extra or missing chromosomes. |
...
|---|---|---|
| Sister chromatids | Homologous chromosomes | Sister chromatids are identical copies of *one* chromosome; homologs are the matched pair (one maternal, one paternal) carrying the same genes but often different alleles. |
| Meiosis | Mitosis performed twice | Meiosis I is fundamentally different (homologs separate); meiosis II resembles mitosis but starts haploid. |
| "Reduction division" | DNA halved before division | DNA is fully replicated in S phase before meiosis; the *chromosome number* is halved at meiosis I by separating homologs. |
| Crossing over | Happening between sister chromatids | Crossing over occurs between **nonsister** chromatids of homologous chromosomes — that is what creates new allele combinations. |
| Haploid cell | Cell with half its DNA damaged | Haploid means one chromosome set (n), a normal state for gametes — not a defect. |
| Nondisjunction | A normal part of meiosis | It is an error in chromosome separation; when it happens, gametes get the wrong chromosome number. |
...
1. To produce haploid gametes (n) for sexual reproduction, so chromosome number stays constant across generations; one diploid starting cell produces four haploid cells.
2. Anaphase I separates homologous chromosomes (each still made of two sister chromatids); anaphase II separates the sister chromatids of each chromosome.
3. Because the DNA was already replicated once before meiosis I, and the reduction in chromosome number was achieved in meiosis I; no second copy is needed for meiosis II to separate sister chromatids.
4. Synapsis is the pairing of homologous chromosomes into tetrads, and crossing over is the exchange of segments between nonsister chromatids; both occur in prophase I.
5. Gametes have n = 4 chromosomes; independent assortment alone gives 2⁴ = 16 possible combinations.
6. Both separate sister chromatids in anaphase with a similar spindle mechanism; meiosis II differs in starting from haploid cells (so it produces gametes, not identical diploid copies) and has no chromosome pairing.
...
- Related: [Cell Division](../chapter-10-cell-reproduction/01-cell-division.md) — mitosis, the process meiosis is contrasted with
- Related: [The Cell Cycle](../chapter-10-cell-reproduction/02-the-cell-cycle.md) — the cycle meiosis modifies
- Related: [Chromosomal Theory and Genetic Linkages](../chapter-13-modern-understandings-of-inheritance/01-chromosomal-theory-and-genetic-linkages.md) — where meiosis's chromosome behavior meets inheritance
