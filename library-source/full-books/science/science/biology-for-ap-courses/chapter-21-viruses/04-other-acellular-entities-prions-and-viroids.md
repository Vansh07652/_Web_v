...
> **Chapter:** [Chapter 21: Viruses](../README.md)  
> **Topic:** 4  
> **Source structure:** OpenStax public textbook outline

## Overview

Viruses are not the only infectious agents that lack cells. Two other acellular entities — **prions** and **viroids** — stretch the definition of life even further. A **prion** is an infectious agent that is a protein and nothing else: no DNA, no RNA, no capsid, no membrane. A **viroid** is a naked, circular piece of RNA: no capsid, no protein coat, just a few hundred nucleotides. Both cause disease, both reproduce inside living cells using host machinery (or, in the prion's case, other copies of the same protein), and neither fits neatly in the virus box.
...
|---|---|---|
| Prion | Infectious agent made only of a misfolded protein, with no nucleic acid genome | Challenges the idea that genetic information requires DNA or RNA |
| PrP^C | The normal cellular prion protein, mainly in nervous tissue | The normal starting material that misfolding corrupts |
| PrP^Sc | The misfolded, disease-associated prion protein | Acts as a template converting normal PrP^C into more misfolded copies |
| Transmissible spongiform encephalopathy (TSE) | Fatal brain disease family caused by prions, named for sponge-like holes in brain tissue | Includes CJD, kuru, vCJD, scrapie, BSE |
| Kuru | Prion disease spread among the Fore people through endocannibalistic practices | Classic example of acquired transmission; declined when the practice stopped |
| Variant CJD (vCJD) | Human prion disease linked to exposure to BSE-contaminated cattle tissue | Brought prions into food-safety and public-health policy |
| Viroid | Naked, circular, single-stranded RNA infecting plants; no capsid, no proteins | Smallest known infectious agents; cause major crop losses |
| Protein-only hypothesis | Proposal that prion infectivity resides entirely in protein conformation | The organizing idea of the topic, supported by nucleic-acid-destruction experiments |
| Hepatitis delta virus (HDV) | Viroid-like human RNA agent needing hepatitis B virus to replicate | Shows the viroid strategy can work in animal hosts with help |

## Example: The Evidence Trail for the Protein-Only Hypothesis
...
1. What is the protein-only hypothesis, and what evidence supports it?
2. How does PrP^Sc "replicate" without any nucleic acid?
3. Name three ways prion diseases arise in humans, with one example each.
4. Why are standard sterilization procedures insufficient for prion-contaminated instruments?
5. What is a viroid, and how does it differ from a virus?
6. How is hepatitis delta virus like a viroid, and why does it need hepatitis B?

<details>
<summary>Show answers</summary>

1. The protein-only hypothesis states that prion infectivity is carried by a misfolded protein with no nucleic acid genome. Evidence: treatments that destroy nucleic acids (radiation, nucleases) leave infectivity intact, while treatments that destroy proteins (proteases) eliminate it.
2. PrP^Sc acts as a template: contact with normal PrP^C induces it to misfold into the PrP^Sc shape; new misfolded molecules convert more, and because PrP^Sc resists proteases, it accumulates — an autocatalytic chain.
3. Sporadic (classic CJD, no known exposure); inherited (mutations in the PrP gene); acquired (kuru via endocannibalism, vCJD linked to BSE-contaminated tissue, or iatrogenic exposure).
4. PrP^Sc is extraordinarily stable: standard heat, radiation, and many chemical disinfectants do not reliably destroy it; effective decontamination needs specialized protocols used in regulated settings.
5. A viroid is naked circular single-stranded RNA of a few hundred nucleotides infecting plants; it has no capsid and encodes no proteins, replicating by hijacking host RNA polymerase. A virus has a capsid, encodes proteins, and typically has a larger genome.
6. HDV is a small circular RNA encoding almost nothing, so it cannot complete its life cycle alone; it depends on hepatitis B virus to supply the missing proteins, so HDV infection occurs only with concurrent HBV infection.

</details>

## Related Topics

- Previous: [Prevention and Treatment of Viral Infections](03-prevention-and-treatment-of-viral-infections.md)
- Next: End of chapter
- Related: [Viral Evolution, Morphology, and Classification](01-viral-evolution-morphology-and-classification.md), [Virus Infection and Hosts](02-virus-infection-and-hosts.md)
- Chapter overview: [Viruses](../README.md)
...
- Prion disease details, transmission routes, and decontamination standards are framed as commonly taught textbook concepts; verify current public-health guidance and facility protocols against authoritative sources. Person-first language used throughout.
