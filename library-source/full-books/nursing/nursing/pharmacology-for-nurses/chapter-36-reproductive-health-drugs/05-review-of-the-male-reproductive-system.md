---
title: "Review of the Male Reproductive System"
subject: "Nursing"
...
> **Chapter:** [Chapter 36: Reproductive Health Drugs](../README.md)  
> **Topic:** 5  
> **Source structure:** OpenStax public textbook outline

## Overview

The male reproductive system does two jobs: it produces and delivers **sperm** (spermatogenesis), and it produces **testosterone**, the androgen that drives male development and maintenance. The anatomy is compact, but the pharmacology built on top of it is extensive: every drug class in the rest of this chapter — androgens, antiandrogens, phosphodiesterase 5 (PDE5) inhibitors, alpha blockers, and 5-alpha-reductase inhibitors — acts on a structure, receptor, enzyme, or feedback loop introduced in this topic. If you understand the system, the drugs stop being a list of names and become a set of levers on one machine.
...
- **Testes.** Two functions in one organ: the seminiferous tubules produce sperm, with support from **Sertoli cells**; the **Leydig cells** in the tissue between tubules produce testosterone.
...
The hypothalamus releases **gonadotropin-releasing hormone (GnRH)** in pulses. GnRH travels to the anterior pituitary, which responds by releasing two hormones:

- **Luteinizing hormone (LH)** → stimulates Leydig cells → testosterone production.
- **Follicle-stimulating hormone (FSH)** → acts on Sertoli cells → supports spermatogenesis (working together with testosterone).
...
|---|---|---|
| GnRH | Hypothalamic hormone that triggers LH and FSH release | Top of the axis; GnRH drugs can shut down testosterone production |
| LH | Pituitary hormone that stimulates Leydig cells | Drives testosterone production |
| FSH | Pituitary hormone that supports spermatogenesis via Sertoli cells | The fertility side of the axis |
| Leydig cells | Testosterone-producing cells in the testes | Source of the body's own androgen |
| Sertoli cells | Support cells in the seminiferous tubules | Nourish sperm, make inhibin, respond to FSH |
| Testosterone | The principal androgen | Drives male development and maintenance; the target of androgen therapy and antiandrogens |
| DHT | Testosterone metabolite formed by 5-alpha-reductase | Drives prostate growth — key to Topics 6 and 8 |
| Spermatogenesis | Sperm production in the seminiferous tubules | The fertility function of the system |
| cGMP | Second messenger that relaxes cavernosal smooth muscle | The molecule PDE5 inhibitors protect (Topic 7) |

## Example: Tracing a Feedback Loop in a Man Using Extra Testosterone

Mr. V., age 34, buys testosterone products online to build muscle. Trace what happens to his HPG axis, step by step:

1. Exogenous testosterone raises his blood androgen level well above normal.
2. The hypothalamus and pituitary sense the high level and cut back: GnRH and LH fall.
3. With less LH, his own Leydig cells stop producing testosterone; with less FSH, his Sertoli cells slow spermatogenesis.
4. Over weeks, his sperm count drops and his testes shrink — his body's own factory has been turned down by the negative feedback loop.
5. When he stops the product, recovery can take months, and fertility may not return to baseline quickly.
...
1. What are the two functions of the testes, and which cells perform each?
2. Describe the HPG axis and its negative feedback loops.
3. Why does exogenous testosterone reduce sperm count?
4. What is the NO → cGMP pathway, and which enzyme terminates it?
5. Why can alpha blockers cause retrograde ejaculation?
6. Where do sperm gain motility, and why does scrotal temperature matter?

<details>
<summary>Show answers</summary>

1. Sperm production in the seminiferous tubules (Sertoli cells) and testosterone production in the Leydig cells.
2. Hypothalamus releases GnRH → pituitary releases LH and FSH → LH drives Leydig cells to make testosterone, FSH supports spermatogenesis via Sertoli cells; testosterone inhibits GnRH/LH and inhibin inhibits FSH.
3. Exogenous testosterone raises blood androgen levels, which the hypothalamus and pituitary sense; negative feedback lowers GnRH and LH (and FSH), so the testes make less testosterone and fewer sperm.
4. Sexual stimulation → nitric oxide → guanylate cyclase → cGMP → cavernosal smooth muscle relaxation → erection; PDE5 degrades cGMP and ends the signal.
5. Alpha-1 receptors help contract prostate and bladder-neck smooth muscle during ejaculation; blocking them can leave the bladder neck open, so semen travels backward into the bladder.
6. In the epididymis; spermatogenesis requires the cooler temperature of the scrotum.

</details>

## Related Topics

- Previous: [Bisphosphonates, Calcium Preparations, Vitamin D, and Estrogen Receptor Modulators](04-bisphosphonates-calcium-preparations-vitamin-d-and-estrogen-receptor-modulators.md)
- Next: [Androgens, Antiandrogens, and Anabolic Steroids](06-androgens-antiandrogens-and-anabolic-steroids.md)
- Related: [Phosphodiesterase 5 Inhibitors](07-phosphodiesterase-5-inhibitors.md) · [Alpha Blockers and 5-Alpha-Reductase Inhibitors](08-alpha-blockers-and-5-alpha-reductase-inhibitors.md) · [Reproductive Health Drugs chapter overview](../README.md)
