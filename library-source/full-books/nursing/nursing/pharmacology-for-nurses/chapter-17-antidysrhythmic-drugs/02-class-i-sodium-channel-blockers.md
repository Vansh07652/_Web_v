...
- **Class Ia** (e.g., quinidine, procainamide, disopyramide): moderate sodium blockade, plus **potassium channel blockade** that lengthens repolarization. The combined effect slows conduction *and* prolongs the action potential (prolonged QT). Used for both atrial and ventricular dysrhythmias.
- **Class Ib** (e.g., lidocaine, mexiletine): **fast on-off binding** that preferentially blocks sodium channels in depolarized, rapidly firing tissue — exactly the state of tissue in an ischemic or tachycardic ventricle. Little effect on normal tissue at normal rates. This "use dependence" makes Ib drugs the classic choice for ventricular dysrhythmias, especially with acute ischemia.
- **Class Ic** (e.g., flecainide, propafenone): the **most potent sodium blockade**, markedly slowing conduction with little effect on repolarization. Their strong proarrhythmic potential in certain patient groups (notably structural heart disease) has been well documented, and they are generally reserved for specific supraventricular dysrhythmias in carefully selected patients.
...
|---|---|---|
| Phase 0 | Rapid sodium-driven depolarization that starts a cardiac action potential | Its speed determines conduction velocity; Class I drugs slow it |
| Sodium channel blockade | Drugs plugging the fast sodium channels of cardiac cells | The shared mechanism of all Class I drugs |
| Use dependence | More channel blockade at faster firing rates | Explains efficacy in tachycardias and toxicity risk when rate rises |
| Class Ia | Moderate sodium blockade plus potassium blockade (e.g., quinidine, procainamide) | Slows conduction and prolongs repolarization; QT prolongation |
| Class Ib | Fast-binding sodium blockade (e.g., lidocaine, mexiletine) | Acts selectively on rapidly firing/ischemic ventricular tissue |
| Class Ic | Potent sodium blockade (e.g., flecainide, propafenone) | Marked conduction slowing; significant proarrhythmia potential |
| Proarrhythmia | Drug-induced new or worsened dysrhythmia | The central safety concern for the entire class |
| CAST trial | Landmark study of Class Ic drugs in structural heart disease | Taught that suppressing ectopy is not the same as improving survival |

## Example: Reading the Monitor Through the Mechanism
...
1. **Why Ib?** His ventricular tissue is irritable and partially ischemic. A fast-binding Ib drug (e.g., lidocaine) preferentially blocks channels in exactly those rapidly firing cells, quieting them without measurably slowing his normal conduction.
2. **What should the strip show if it's working?** Fewer premature ventricular contractions and no runs of VT, while the QRS of the underlying rhythm stays narrow — the drug should not slow *normal* tissue.
3. **What would toxicity look like?** A widening QRS at the baseline rhythm, new bradycardia, heart block, or *more* ectopy — all signs that channel block has gone too far, and reasons to notify the prescriber promptly.
4. **What else matters?** Potassium and magnesium levels, renal/hepatic function (which affect elimination), and symptoms (lightheadedness, syncope, chest pain). Choosing the dose belongs to the prescriber; the nurse verifies the order against the current formulary and facility policy before administration.
...
1. Which phase of the cardiac action potential do Class I drugs target, and what ion is involved?
2. A drug binds sodium channels tightly and slowly, markedly slowing conduction with little effect on repolarization. Which subclass is it (Ia, Ib, or Ic)?
3. Why does lidocaine (Ib) suppress ectopy in an ischemic ventricle without noticeably slowing a normal rhythm?
4. What does a progressively widening QRS on the monitor suggest in a patient receiving a Class I drug, and what should the nurse do?
5. What was the key lesson of the CAST trial, and why does it still shape prescribing of Class I drugs?
6. Which electrolyte abnormalities most directly affect the safety of Class I drug therapy, and why?
<details>
<summary>Show answers</summary>

1. Phase 0 — the rapid depolarization driven by sodium (Na⁺) influx through fast sodium channels.
2. Class Ic (e.g., flecainide, propafenone) — the most potent sodium channel blockade with minimal repolarization effect.
3. Because of use dependence plus its fast on-off binding: lidocaine blocks channels preferentially in rapidly firing, depolarized (ischemic) tissue and largely clears from normal channels between beats. Normal tissue at normal rates is barely affected.
...
5. The CAST trial showed that drugs that successfully suppressed premature ventricular contractions increased mortality in people with structural heart disease. It taught that suppressing ectopy on the monitor is not a valid goal by itself and that these drugs carry real proarrhythmic mortality risk — so patient selection matters more than rhythm suppression.
6. Low potassium (hypokalemia) and low magnesium — both destabilize repolarization and increase the risk of serious dysrhythmias, including torsades de pointes; they can also blunt or exaggerate the drugs' effects. Correction per provider orders is part of safe therapy.

</details>

## Related Topics

- Previous: [Introduction to Dysrhythmias](01-introduction-to-dysrhythmias.md)
- Next: [Class II: Beta Adrenergic Blockers](03-class-ii-beta-adrenergic-blockers.md)
- Related: [Antidysrhythmic Drugs chapter overview](../README.md)
...
- Content type: Original educational study guide based on OpenStax outline structure. Mechanism-level concepts only; no dosing or administration recommendations. Verify all clinical information against current references, formulary, and prescriber orders.
