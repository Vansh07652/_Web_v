...
> **Chapter:** [Chapter 10: Specimen Collection and Lab Testing](../README.md)  
> **Topic:** 3  
> **Source structure:** OpenStax public textbook outline

## Overview

Sputum is the mucus produced in the lower airways — the trachea, bronchi, and lungs — that a person brings up by coughing. Healthy airways make small amounts of mucus to trap dust and microbes, but infection, inflammation, or chronic lung disease can change both the amount and the character of that mucus, sometimes making it thick, discolored, or streaked with blood. **Sputum collection** is the skill of capturing a sample of that material in a sterile container so the laboratory can examine it. The whole skill is built around one idea: *the test result is only as good as the specimen.* A container that looks full may still be useless if what is inside is mostly saliva from the mouth rather than secretions from deep in the lungs.

Sputum specimens are collected for several kinds of tests — most commonly a culture and sensitivity (C&S) to identify infection-causing bacteria, an acid-fast bacillus (AFB) study when tuberculosis is suspected, and cytology to examine cells. The collection method varies with the patient's ability to cough: most patients can cough a sample up directly (expectorated), some need a saline mist to trigger a cough (induced), and others who cannot cough effectively may need the specimen obtained with suction (per facility policy and scope of practice).
...
- **Sputum cytology:** examines cells in the sputum, sometimes ordered when a malignancy or other cellular changes are suspected.
...
|---|---|---|
| Sputum | Mucus produced in the lower airways and brought up by coughing | The substance the test is meant to analyze; its quality determines the validity of results |
| Saliva | Fluid produced in the mouth | The main contaminant that ruins sputum specimens |
| Expectorated specimen | A sample coughed up by the patient | The most common collection method; depends on good coaching |
| Induced specimen | A sample obtained after inhaling a saline mist that stimulates coughing | Used when the patient cannot cough up sputum on their own |
| Culture and sensitivity (C&S) | A test that grows organisms and checks which antimicrobials may work against them | Guides targeted treatment and supports antibiotic stewardship |
| AFB (acid-fast bacilli) | A category of organisms that includes the bacteria causing tuberculosis | Dictates special collection protocols and airborne precautions |
| Sputum cytology | Microscopic examination of the cells in sputum | Used when cellular changes or malignancy are suspected |
| Specimen rejection | The lab's refusal to process an unacceptable sample | Causes repeat collections and care delays; preventing it is part of the skill |
...
1. Why is a specimen that is mostly saliva a problem for a sputum culture?
2. List three general teaching points that help a patient produce a good expectorated sample.
3. Why should the container be labeled at the bedside rather than before collection?
4. When might a provider order an induced sputum specimen?
5. What information should the nurse document after collecting a sputum specimen?

<details>
<summary>Show answers</summary>

1. Saliva contains mouth organisms that do not reflect what is happening in the lungs, so the culture result may be misleading — or the lab may reject the specimen, requiring a repeat collection and delaying diagnosis.
2. (Any three): collect early in the morning; rinse the mouth with water (not mouthwash); sit upright leaning slightly forward; take two or three deep breaths before coughing; cough forcefully from deep in the chest; splint incisions with a pillow.
3. To ensure the label matches the patient at the moment of collection. Pre-labeling risks labeling errors — the specimen could be attributed to the wrong person.
4. When the patient cannot produce sputum by coughing on their own; the saline mist irritates the airways and stimulates a productive cough. Induction is done per facility protocol.
5. Collection time, method (expectorated, induced, or suctioned), specimen appearance, patient tolerance and response, and any difficulties or deviations — plus notification of the provider if the specimen could not be obtained.

</details>

## Related Topics

- Previous: [Stool Collection](02-stool-collection.md)
- Next: [Blood Sampling](04-blood-sampling.md)
- Related: [Urine Specimen](01-urine-specimen.md)
- Chapter: [Specimen Collection and Lab Testing overview](../README.md)
