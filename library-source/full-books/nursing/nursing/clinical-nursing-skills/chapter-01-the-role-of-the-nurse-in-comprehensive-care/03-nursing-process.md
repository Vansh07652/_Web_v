...
> **Chapter:** [Chapter 1: The Role of the Nurse in Comprehensive Care](../README.md)  
> **Topic:** 3  
> **Source structure:** OpenStax public textbook outline

## Overview

The nursing process is the systematic, cyclical framework nurses use to think through and deliver care. It is usually remembered by the acronym ADPIE: **A**ssessment, **D**iagnosis, **P**lanning (including outcome identification), **I**mplementation, and **E**valuation — some textbooks add "Outcome identification" and call it ADOPIE, but both versions describe the same loop. The nursing process is not a paperwork exercise; it is a discipline of thinking that turns a messy situation — a person in pain, a family in crisis, a unit at capacity — into organized action that can be documented, communicated, and improved.
...
|---|---|---|
| ADPIE | The five phases: Assessment, Diagnosis, Planning, Implementation, Evaluation | The standard framework for nursing care |
| Subjective data | What the person reports (symptoms, feelings, history) | Only the patient can supply it |
| Objective data | What is observed or measured | Verifiable by others; balances the patient's report |
| Nursing diagnosis | Clinical judgment about the person's response to a health condition | Guides nursing interventions |
| Medical diagnosis | Identification of a disease by a provider | A different purpose from nursing diagnosis |
| NANDA-I | The standardized nursing diagnosis taxonomy | Gives nursing a common language for problems |
| Outcome | A measurable, patient-focused goal | The yardstick for evaluation |
| Care plan | Document linking problems, outcomes, and interventions | Organizes and communicates care |
| Independent intervention | An action the nurse can take without an order | The core of nursing authority |

## Example: One Shift, One Full ADPIE Cycle
...
2. Give one example each of subjective and objective data from the same patient.
3. How does a nursing diagnosis differ from a medical diagnosis?
4. Why must evaluation feed back into assessment rather than ending the process?
5. Classify these actions as independent, dependent, or interdependent: repositioning a patient for comfort; giving a prescribed medication; coordinating a physical therapy consult.

<details>
<summary>Show answers</summary>

1. Assessment, Diagnosis, Planning, Implementation, Evaluation.
2. Example: subjective — "my stomach hurts"; objective — the patient grimaces and is guarding the abdomen. Accept any correct pairing.
3. A nursing diagnosis describes the person's response to a health condition (nursing-treatable, uses NANDA-I labels); a medical diagnosis names the disease and is made by a provider.
4. Evaluation generates new assessment data; the person's condition changes, so the plan must be revised and the cycle restarted — otherwise care becomes stale.
5. Repositioning = independent; administering a prescribed medication = dependent; coordinating a physical therapy consult = interdependent/collaborative.
</details>

## Related Topics

- Previous: [Evidence-Based Practice](02-evidence-based-practice.md)
- Next: End of chapter
- Related: [Principles of Nursing Practice](01-principles-of-nursing-practice.md), [The Role of the Nurse in Comprehensive Care chapter overview](../README.md)
