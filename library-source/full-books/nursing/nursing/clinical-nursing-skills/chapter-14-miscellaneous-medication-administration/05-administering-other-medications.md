---
title: "Administering Other Medications"
subject: "Nursing"
...
"Other medications" is the chapter's catch-all for routes that deliver drugs through mucous membranes and skin: **sublingual** (under the tongue), **buccal** (against the cheek), **transdermal** (through the skin via a patch), **topical** (applied to the skin surface), **vaginal**, and **rectal**. Each route has its own surface, speed of absorption, and technique — but they share one organizing idea: *the medication must stay in contact with the right surface long enough to be absorbed*. A sublingual tablet that is swallowed, an old patch left under a new one, or a cream applied over a dirty layer all fail the same way — the drug never does its job. These routes are also common in home care, making teaching central: the person who applies their own patch or gives their own suppository needs to understand not just *how*, but *why* each step matters.

## Why This Matters

These routes handle some of the most consequential medications — rescue medications that must work in minutes, hormones and pain medications that deliver steady levels over days, and treatments people rely on for chronic conditions. They are also fertile ground for errors: swallowing a sublingual dose, applying a new patch over an old one (a double dose), or using the wrong applicator. Because many of these medications are self-administered at home, the nurse is often the last trained person to see the technique — knowing the surface, the placement, and the timing for each route is a direct patient-safety intervention.
...
|---|---|---|
| sublingual | Placed under the tongue | Absorbs quickly into the bloodstream; must not be swallowed |
| buccal | Placed between the cheek and the gum | Mucous-membrane absorption; must not be chewed or swallowed |
| transdermal | Absorbed through the skin from a patch | Delivers steady levels over the wear time; old patch must be removed first |
| topical | Applied to the skin surface for local effect | Technique (thin, even layer, gloves) determines effect and safety |
| suppository | A solid medication shaped to melt inside a body opening | Must be inserted gently and allowed to melt/absorb in place |
| applicator | Device used to insert vaginal medications | Correct use ensures the dose reaches the right place |
| route | The path by which a medication enters the body | The order specifies it; wrong-route errors are serious and preventable |
...
| Swallowing a sublingual tablet | Letting it dissolve in place | Swallowing routes it through the stomach and liver, delaying or changing its effect — the tablet must dissolve where placed. |
| Removing the old transdermal patch | Applying the new patch on top | Old patch on + new patch = double dose; removal of the old patch is step one. |
| Cutting a transdermal patch to size | Using it whole | Cutting can release the entire dose at once — patches are never cut. |
...
| Vaginal applicator | Rectal administration | Different routes, positions, and products — the order specifies the route, and the two are never interchanged. |
...
1. These routes are designed for rapid absorption through the oral mucosa, bypassing the stomach and liver. Chewing or swallowing changes how and when the drug is absorbed — and some of these medications are rescue drugs that must act quickly.
2. Remove the old patch first. Leaving the old patch on while applying a new one delivers a double dose.
3. Cutting can damage the patch's delivery system and release the entire dose at once instead of over the wear time.
4. Privacy, draping, gentle communication, and assessment (checking for lesions, bleeding, or discomfort before insertion) — plus never forcing insertion and documenting per policy.
5. Apply a thin, even layer to clean, dry skin, wearing gloves per policy. Technique matters because too thick a layer wastes drug and can irritate the skin, and touching the product with bare hands can expose the nurse to the drug.
6. The rights of medication administration — right person, medication, dose, route, time, and documentation — plus the principle that the medication must stay in contact with the correct surface long enough to be absorbed, and that the exact route comes from the order, never improvisation.

</details>

## Related Topics

- Previous: [Administering Inhaled Medications](04-administering-inhaled-medications.md)
- Next: End of chapter
- Related: [Miscellaneous Medication Administration chapter overview](../README.md)
- Broader context: [Chapter 12: Medication Administration Procedures](../chapter-12-medication-administration-procedures/README.md) (oral and parenteral routes)
