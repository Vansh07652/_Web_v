---
title: "Security: Privacy and Informatics"
subject: "Nursing"
...
- **Breach response:** a breach is any unauthorized acquisition, access, use, or disclosure of PHI. Suspected breaches are reported promptly per facility policy — never concealed.
...
|---|---|---|
| Privacy | The patient's right to control who knows their health information | The foundation of trust; the starting point for every sharing decision |
| Confidentiality | The professional duty to protect information shared during care | Violating it breaks trust and can carry legal and professional consequences |
| Security | The technical, physical, and administrative safeguards that protect information | Turns the promise of confidentiality into working practice |
| PHI (protected health information) | Identifiable health information in any form | Knowing what counts as PHI tells you what must be protected |
| HIPAA | US law setting privacy and security standards for health information | The main US legal framework for information protection |
| Minimum necessary | Using only the smallest amount of information needed for the task | The practical rule applied to every use and disclosure |
| EHR | Electronic health record — the digital legal record of care | The central informatics tool; its accuracy and security depend on its users |
| CPOE | Computerized provider order entry — orders entered directly into the system | Reduces transcription errors and enables automatic safety checks |
| Audit trail | A system log of who accessed which record and when | Detects and deters unauthorized access |
| Breach | Unauthorized acquisition, access, use, or disclosure of PHI | Must be reported promptly; hiding a breach compounds the harm |
| Covered entity | A provider, health plan, or clearinghouse that must comply with HIPAA | Defines who is legally bound to protect PHI |
...
1. Privacy is the patient's right to control access to their health information; confidentiality is the professional duty to protect it; security is the technical, physical, and administrative safeguards that make protection possible.
2. Any identifiable health information in any form — name, birth date, medical record number, diagnosis, treatment, and payment information, whether spoken, written, or electronic.
3. Do not confirm or deny. Verify the caller's identity and the patient's authorization following facility policy before releasing any information.
4. Using only the smallest amount of information needed to accomplish the task; it applies to every use and disclosure of PHI.
5. To prevent unauthorized access by anyone passing by. Automatic locks exist for the same reason — leaving a screen open exposes PHI.
6. Report it immediately to the appropriate person (charge nurse, manager, or privacy officer) per facility policy — never ignore or conceal a breach.

</details>

## Related Topics

- Previous: [Safety: Violence](02-safety-violence.md)
- Next: End of chapter
- Related: [Safety and Security chapter overview](../README.md)
