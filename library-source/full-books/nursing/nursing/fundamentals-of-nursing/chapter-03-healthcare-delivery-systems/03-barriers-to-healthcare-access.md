...
> **Chapter:** [Chapter 3: Healthcare Delivery Systems](../README.md)  
> **Topic:** 3  
> **Source structure:** OpenStax public textbook outline

## Overview

**Access to healthcare** means the ability to obtain needed health services at the right time and in the right place. A **barrier to access** is anything that blocks, delays, or discourages a person from getting that care. Barriers are commonly grouped into categories: **financial** (cost, insurance), **geographic and transportation** (distance, no ride), **structural and system** (long waits, limited hours, workforce shortages), **personal, cultural, and informational** (language, health literacy, mistrust, stigma), and the broader **social determinants of health** (income, housing, food, education) that shape whether people can act on health advice at all.
...
Cost is the most common barrier. People may be **uninsured** (no coverage at all) or **underinsured** (coverage that still leaves high out-of-pocket costs: deductibles, co-pays, uncovered services). Even people with coverage sometimes skip appointments, medications, or tests because of cost. Facilities and systems offer financial assistance, sliding-scale programs, and charity care — the availability and rules vary widely, so know what exists in your community. Payment and insurance structures also differ dramatically between countries; the concepts generalize even where the specifics do not.
...
|---|---|---|
| Access | The ability to obtain needed health services at the right time and place | The gateway to prevention, diagnosis, and treatment |
| Uninsured | Having no health coverage at all | Faces the full cost of care; may delay or skip needed services |
| Underinsured | Having coverage that still leaves high out-of-pocket costs | Cost barriers persist even with insurance — skipping care is common |
| Health literacy | The ability to obtain, understand, and use health information | Low health literacy blocks understanding of when and how to seek care |
| Social determinants of health | The conditions of daily life — income, housing, food, education, transportation | The upstream drivers of health and of access to care |
| Patient navigation | Programs or workers who help people find and use health services | Reduces structural barriers like referrals, scheduling, and follow-up |
| Case management | Coordination of a patient's care and resources across providers and settings | Connects complex-needs patients to services and prevents gaps |
| Telehealth | Health services delivered remotely by phone or video | Expands reach — but requires devices, internet, and digital skills |
| Digital divide | The gap between people with and without access to technology and internet | Telehealth can widen disparities if offered without alternatives |
...
|---|---|---|
| Access | Utilization | Access is the ability to obtain care; utilization is actually using it. People can access care and still not use it (fear, mistrust, cost) — and use without true access is possible (e.g., one distant, unaffordable option) |
| Uninsured | Underinsured | Uninsured = no coverage; underinsured = coverage with high out-of-pocket costs. Both face cost barriers |
| "No-show" = noncompliance | A sign of access barriers | Missed appointments often reflect transportation, cost, work conflicts, or fear — assess before labeling the patient |
| Telehealth removes all barriers | A partial solution | Telehealth needs devices, internet, and digital skills — it can create a digital divide without alternatives |
| Health literacy | General literacy | A highly literate person can still have low health literacy; medical language is unfamiliar to almost everyone |
| Geographic barriers | A rural-only problem | Cities have transit deserts, long commutes, and clinics with hours that conflict with work |
