---
title: "Legal Dimensions of Care"
subject: "Nursing"
...
> **Chapter:** [Chapter 16: Legal and Ethical Considerations](../README.md)  
> **Topic:** 3  
...
The **legal dimensions of care** cover: how nursing is licensed and what "scope of practice" means; the civil wrongs (torts) a nurse can commit, especially negligence and malpractice; consent for treatment; confidentiality and privacy; documentation as a legal record; mandatory reporting duties; advance directives; and incident reports. Two themes run through it: **law varies by jurisdiction** (state/provincial and national law differ; facility policy adds another layer), and **the nurse is personally accountable** for practicing within their own license and standards.
...
- **Assault:** threatening harmful or offensive contact (e.g., "I'll restrain you if you don't settle down" — the threat itself is the wrong).
- **Battery:** actual harmful or offensive physical contact without consent (e.g., giving an injection the patient refused).
- **False imprisonment:** unlawful restraint of a person's freedom of movement (e.g., improper restraint use or blocking a patient from leaving).
...
|---|---|---|
| Nurse practice act | The law defining nursing practice and scope in a jurisdiction | The legal source of what you may and may not do |
| Assault | Threatening harmful or offensive contact | The threat alone is a wrong — no touching needed |
| Battery | Harmful or offensive contact without consent | Giving care after a refusal is battery |
| False imprisonment | Unlawfully restraining a person's freedom of movement | Applies to improper restraint use or blocking a patient's exit |
| Malpractice | Negligence by a professional within their role | Four elements: duty, breach, causation, damages |
| Informed consent | Voluntary, informed agreement by a person with capacity | Valid only if understood; can be withdrawn anytime |
| HIPAA | U.S. federal law protecting health information privacy/security | The legal backbone of confidentiality (other countries have equivalents) |
| Advance directive | Documents stating care wishes for when a person can't decide | Living will, health care power of attorney, DNR orders |
| Incident report | Internal document of an untoward event for risk review | Not part of the medical record — follow facility policy |

## Example: Analyzing an error through the four elements
...
1. List the four elements of malpractice and explain why a claim fails if any one is missing.
2. A patient says "no" to an injection and the nurse gives it anyway. What tort(s) occurred, and why?
3. What is the difference between assault and battery? Give an example of assault *without* battery.
4. What is a nurse's legal role in informed consent — and what should the nurse do if the patient withdraws consent after signing?
5. Where do incident reports belong, and what should (and shouldn't) go in the patient's chart after a medication error?
6. Why does scope of practice matter legally, even when a provider or supervisor directs a task?

<details>
<summary>Show answers</summary>

1. **Duty** (a nurse–patient relationship existed), **breach of duty** (conduct fell below the standard of care), **causation** (the breach caused the injury), and **damages** (actual harm resulted). All four must be present; without causation or damages the claim fails even if the nurse erred — malpractice is about proven harm, not mere mistake.
2. **Battery** — actual unwanted physical contact without consent. Depending on what was said beforehand, there may also be **assault** (the threat). Administering care after an explicit refusal is a classic battery scenario.
3. Assault is threatening harmful or offensive contact; battery is the contact itself. Example of assault without battery: telling a patient "I'll restrain you if you don't calm down" — the threat alone is the wrong, even if no physical contact follows.
4. The person performing the procedure obtains informed consent; the nurse confirms the patient received understandable information, witnesses signatures per policy, and relays questions to the provider. If the patient withdraws consent — even after signing — the nurse stops, notifies the provider, and documents the refusal; a signed form does not override a current withdrawal.
5. Incident reports are internal risk-management documents kept separate from the medical record (per law/policy) and are not mentioned in the chart. The chart gets the clinical facts — what was given, the patient's response, the provider notification, the assessment — objectively, without blame.
6. Because scope of practice is defined by law and policy, not by individual orders or supervisors. Performing an act outside your scope — or one you are not competent to perform — is a legal and safety violation attributable to the nurse regardless of who directed it; decline, explain the limit, and escalate appropriately.
</details>

## Related Topics

- Previous: [Ethics in Nursing Practice](02-ethics-in-nursing-practice.md)
- Next: [Advocacy in Nursing Practice](04-advocacy-in-nursing-practice.md)
- Related: [Value Considerations of Care](01-value-considerations-of-care.md)
- Related: [Legal and Ethical Considerations chapter overview](../README.md)
