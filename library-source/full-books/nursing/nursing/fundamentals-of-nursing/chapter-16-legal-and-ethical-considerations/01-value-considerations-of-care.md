---
title: "Value Considerations of Care"
subject: "Nursing"
...
Values matter for the nurse, too. Every nurse brings personal values into the room; when those collide with a patient's choices, the nurse can feel judgment, discomfort, or distress. Professional nursing requires awareness of your own values — built through **values clarification** — so you can care for people without imposing your value system on them. It is a tested skill and a daily duty.
...
- **Professional values** are the commitments of the profession — for nursing: respect for human dignity, the primacy of the patient's interests, compassion, integrity, accountability, and social justice — codified in documents like the ANA *Code of Ethics for Nurses* (U.S.) and equivalent codes internationally (Topic 2).
...
|---|---|---|
| Value | A deeply held belief about what is important or worthwhile | The engine behind most patient choices — and most conflicts |
| Personal values | The beliefs an individual holds from life experience | Must be recognized in yourself so they don't silently drive your care |
| Professional values | The commitments of the profession (dignity, patient's interests, integrity) | The standard governing the nurse's conduct regardless of personal belief |
| Values clarification | Naming, examining, and honestly assessing your own values | Builds the self-awareness that prevents imposing values on patients |
| Moral distress | Anguish from knowing the right thing and being blocked from doing it | A real consequence of unresolved value conflicts — with known supports |
| Conscientious objection | Declining to participate in a specific act on moral grounds | Permitted in some settings with conditions — never abandonment |

## Example: A refusal that was about values, not understanding
...
1. A patient declines a treatment you believe is clearly beneficial. Before re-explaining the treatment, what should you do, and why?
2. What is values clarification, and what is it *not* for?
3. Give an example of how personal and professional values can conflict, and what the professional response is.
4. A colleague says, "Patients from that community always refuse this." What is the respectful, accurate response?
5. What is moral distress, and what should a nurse do when it develops?

<details>
<summary>Show answers</summary>

1. Ask what matters most to the patient in this decision (e.g., "What are your main concerns?"). Refusal is often a values-based choice, not a comprehension failure — understanding the patient's values first prevents treating a legitimate preference as a misunderstanding.
2. Values clarification is the process of identifying, examining, and ranking your own values — where they came from, how strongly you hold them, whether your behavior matches. It is *not* for changing anyone's values or telling patients what they should value.
3. Example: a nurse personally believes all blood products should be accepted, but a patient lawfully refuses them on religious grounds. The professional response: keep personal belief separate from professional duty — provide respectful care, honor the lawful refusal, document, and involve the team/ethics resources as needed.
4. That assumption is a stereotype: culture informs values but does not dictate them, and individuals within any community vary. Ask each patient directly about their preferences and document them.
5. Moral distress is the anguish of knowing the right thing and being unable to do it. The nurse should not carry it silently: discuss with supervisors/preceptors, use debriefing, and access employee support or ethics resources per institutional policy.
</details>

## Related Topics

- Previous: Start of chapter
- Next: [Ethics in Nursing Practice](02-ethics-in-nursing-practice.md)
- Related: [Advocacy in Nursing Practice](04-advocacy-in-nursing-practice.md)
