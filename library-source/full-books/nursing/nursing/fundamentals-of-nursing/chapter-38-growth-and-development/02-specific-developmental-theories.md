---
title: "Specific Developmental Theories"
subject: "Nursing"
...
Erikson described eight stages across the lifespan; each is a crisis between two outcomes that must be reasonably resolved to move on. A positive resolution builds a **virtue**; a poor resolution leaves a weakness that later stages can still partially repair — no stage is a life sentence.

| Stage (approximate age) | Crisis | Virtue if resolved | Nursing application |
|---|---|---|---|
| Infancy (0–~1 yr) | Trust vs. mistrust | Hope | Respond consistently to cries; parent involvement; minimize separation |
| Toddler (1–3 yrs) | Autonomy vs. shame/doubt | Will | Offer choices within limits; allow self-feeding and self-dressing; avoid power struggles |
| Preschool (3–6 yrs) | Initiative vs. guilt | Purpose | Encourage imaginative play and trying new things; don't shame mistakes |
| School-age (6–12 yrs) | Industry vs. inferiority | Competence | Let the child help and complete tasks; praise effort; teach about their condition |
| Adolescence (12–19 yrs) | Identity vs. role confusion | Fidelity | Respect privacy; support peer relationships; confidentiality within legal limits |
| Young adult (20–40 yrs) | Intimacy vs. isolation | Love | Support relationships and life transitions (partner, career, parenting) |
| Middle adult (40–65 yrs) | Generativity vs. stagnation | Care | Support contribution to family/work/community; caregiver roles |
| Older adult (65+) | Ego integrity vs. despair | Wisdom | Honor life review and reminiscence; support dignity and independence |

### Piaget's cognitive development

Piaget explained how thinking itself changes with age — not what children know, but *how they reason*.

- **Sensorimotor (0–~2 yrs):** infants learn through senses and movement; object permanence (knowing something exists when out of sight) develops near the end. *Nursing:* keep familiar objects present; talk while handling the infant.
...
- **Concrete operational (7–~11 yrs):** logical thinking about concrete things; understands conservation and cause-and-effect; still struggles with pure abstractions. *Nursing:* explain step by step with real objects (show the equipment); the child can reason "if I take this medicine, my cough gets better."
...
|---|---|---|
| Psychosocial theory | Erikson's 8 lifespan stages, each a crisis between two outcomes | Predicts behavior and needs at every age — exam-critical |
| Virtue | The strength gained when a stage crisis is reasonably resolved | Guides what to nurture: hope, will, purpose, competence… |
| Object permanence | Knowing something exists when it is out of sight | Develops in the sensorimotor stage; explains separation anxiety and peek-a-boo |
| Egocentrism | Seeing the world only from one's own viewpoint | Preoperational thinking; a child may blame themselves for an illness |
| Conservation | Understanding that amount stays the same despite changes in shape | A concrete-operational skill — don't expect it before ~age 7 |
| Moral reasoning | The *way* a person justifies right and wrong | Kohlberg's levels predict how children understand rules and treatments |
| Secure attachment | A bond where the child uses the caregiver as a safe base | Built by consistent, responsive care; supports healthy development |
| Developmental task | A skill or achievement expected in a life period | Guides anticipatory guidance and education |
| Hierarchy of needs | Maslow's ordered needs: physiological → safety → belonging → esteem → self-actualization | Lower needs take priority in care and teaching |
| Theory | A framework that organizes observations and predicts behavior | A lens, not a law — confirm with the actual person |
...
|---|---|---|
| Erikson | Piaget | Erikson = psychosocial stages/crises across the whole lifespan; Piaget = cognitive stages of how children reason |
| Trust vs. mistrust | Autonomy vs. shame/doubt | Infancy (trust) vs. toddlerhood (autonomy) — the toddler's "no" is autonomy, not distrust |
| Initiative | Industry | Preschoolers take initiative in play (initiative vs. guilt); school-age children work to master skills (industry vs. inferiority) |
| Preoperational | Concrete operational | Preoperational = egocentric, no logic (2–7); concrete operational = logic with concrete things (7–11) |
| Kohlberg's levels | Actual moral behavior | The theory describes how people *justify* right and wrong, not whether they do the right thing |
| A theory predicting a person | A theory describing a pattern | Theories describe typical patterns; individuals vary — never use a stage as a label |
| Secure attachment | Always happy behavior | A securely attached child can cry at separation — security is about being comforted and using the caregiver as a base |
| Freud's theory | Current nursing guidance | Freud's stage theory is largely historical in modern nursing; use current developmental evidence |
...
1. Autonomy vs. shame/doubt. Support: offer choices within safe limits, allow self-feeding/dressing, avoid power struggles, and give the child a sense of control.
2. Use simple, concrete language tied to what the child can see and feel — e.g., "This medicine helps your cough go away so you can play" — rather than abstract explanations about germs or immune systems.
3. Object permanence is knowing that something still exists when out of sight; it develops in the sensorimotor stage (infancy).
4. Secure, insecure-avoidant, insecure-resistant/ambivalent, and disorganized. Consistent, responsive caregiving promotes secure attachment.
5. Meet the physiological need first — offer food/fluid and address comfort — because lower-level needs take priority before a person can focus on learning.
6. Theories describe typical patterns observed in particular times and cultures; individuals vary in timing, culture, ability, and experience. Use them to form hypotheses, then confirm with the actual person.

</details>

## Related Topics

- Previous: [Stages of Growth and Development](01-stages-of-growth-and-development.md)
- Next: [Application to Care](03-application-to-care.md)
