---
title: "Evidence-Based Clinical Decisions"
subject: "Nursing"
book: "Fundamentals of Nursing"
chapter: "15: Evidence-Based Research, Quality Improvement, and Collaborative Practice"
topic_number: "2"
...
> **Chapter:** [Chapter 15: Evidence-Based Research, Quality Improvement, and Collaborative Practice](../README.md)  
> **Topic:** 2  
> **Source structure:** OpenStax public textbook outline

## Overview

Evidence-based clinical decisions happen at the moment research findings meet a real patient. The previous topic covered how evidence is produced and appraised; this topic covers how a nurse actually *uses* evidence. The core idea is a three-legged stool: a sound clinical decision integrates (1) the **best available research evidence**, (2) the nurse's **clinical expertise**, and (3) the **patient's preferences, values, and circumstances**. Remove or ignore any leg, and the decision wobbles — evidence without expertise is applied blindly, expertise without evidence drifts into habit, and either without the patient's voice ignores the person the decision is about.
...
1. **Best available evidence.** The highest-quality research applicable to the question — but "best available" is honest about gaps: when no strong study exists, you use the best you have and note the uncertainty.
2. **Clinical expertise.** Your assessment skills, experience with similar patients, knowledge of the individual patient, and ability to recognize when a general finding does not apply. Expertise is what lets you see that a guideline for the "typical" patient needs adjusting for the patient in front of you.
3. **Patient preferences and values.** What matters to the patient — their goals, culture, family situation, fears, and informed choices. Respecting preferences does not mean abandoning evidence; it means education and shared decision-making so the patient can choose with open eyes.

### The five steps of EBP: Ask, Acquire, Appraise, Apply, Assess

- **Ask:** convert a clinical uncertainty into a focused question (PICOT — Population, Intervention, Comparison, Outcome, Time).
...
|---|---|---|
| Clinical expertise | The nurse's accumulated knowledge, assessment skills, and judgment | Evidence is applied through expertise; it is what tailors general findings to an individual |
| Patient preferences and values | The patient's goals, beliefs, culture, and informed choices about care | Keeps decisions person-centered and respects autonomy |
| Shared decision-making | Clinician and patient reach a care decision together after open discussion | Turns "doctor knows best" into a partnership and improves adherence and trust |
| Clinical practice guideline | A systematically developed statement of evidence-based recommendations | A time-saving synthesis, but a tool to individualize, not a rule |
| Protocol / standing order | Facility-approved instructions for managing specific situations | Defines what the nurse may do and when — always follow your facility's version |
| Appraisal | Judging a study's validity, importance, and applicability | Prevents applying weak or irrelevant evidence |
| PICOT | Population, Intervention, Comparison, Outcome, Time question format | Structures the "Ask" step so searches and decisions stay focused |
| Autonomy | The patient's right to make informed decisions about their own care | Explains why an informed patient may decline even evidence-supported care |

## Example: The Triad in Action
...
1. Name the three components of an evidence-based clinical decision.
2. List the five steps of EBP in order.
3. A patient with a strong evidence-based recommendation declines the recommended intervention after a full, understandable discussion. What should the nurse do?
4. Why is clinical expertise a necessary part of the triad rather than a nice extra?
5. A nurse finds a well-done study on a different patient population. What should she do before applying it?

<details>
<summary>Show answers</summary>

1. Best available research evidence, clinical expertise, and patient preferences/values. All three must be integrated.
2. Ask (formulate the question, e.g., with PICOT), Acquire (search for evidence), Appraise (judge quality and applicability), Apply (integrate with expertise and preferences; act within scope and policy), Assess (evaluate the outcome for this patient).
3. Respect the patient's autonomy: ensure the decision is genuinely informed, provide education and support, involve the care team as appropriate, and document the discussion, education, and the patient's decision. Do not coerce.
4. Evidence describes populations, not individuals. Expertise — assessment skills, experience, and knowledge of this patient — is what detects when a general recommendation does or does not fit the person in front of you.
5. Appraise the study and check applicability before applying it: consider whether the population, setting, and interventions are similar enough to her patients, and whether her facility's policies and scope of practice permit the intervention. A single study is also not enough on its own — check for guidelines or systematic reviews.

</details>

## Related Topics

- Previous: [Evidence-Based Research](01-evidence-based-research.md)
- Next: [Quality Improvement in Nursing](03-quality-improvement-in-nursing.md)
- Related: [Collaborative Practice](05-collaborative-practice.md), [Interprofessional Approach to Health Care](06-interprofessional-approach-to-health-care.md)
- Chapter: [Evidence-Based Research, Quality Improvement, and Collaborative Practice chapter overview](../README.md)
