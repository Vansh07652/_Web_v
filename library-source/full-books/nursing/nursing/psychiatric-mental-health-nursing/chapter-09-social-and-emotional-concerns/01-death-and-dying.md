...
- **Living will:** a written statement of what treatments a person would or would not want if they become unable to decide (for example, preferences about life-sustaining treatment).
- **Durable power of attorney for health care (health care proxy):** designates a specific person to make health care decisions if the client cannot.
...
|---|---|---|
| Kübler-Ross stages | Five common emotional responses to dying: denial, anger, bargaining, depression, acceptance | The classic vocabulary for talking about the psychology of dying — useful descriptively, harmful as a checklist |
| Palliative care | Care focused on relieving suffering at any stage of serious illness | Can be provided alongside curative treatment; not the same as hospice |
| Hospice care | Comfort-focused end-of-life care when curative treatment has stopped | The end-of-life care model; eligibility and services vary by program and jurisdiction |
| Living will | A written statement of treatment wishes if the person cannot decide | Turns the person's values into guidance for future care |
| Durable power of attorney for health care | A document naming a person to make health decisions if the client cannot | Ensures someone the client trusts can speak for them |
| DNR/DNI order | Provider orders not to perform CPR or intubation | Frequently misunderstood — DNR means no CPR, not "no other treatment" |
| Advance care planning | Discussing and documenting values and wishes for future care | The process that prevents unwanted treatment and family guesswork |
| Postmortem care | Care of the body after death | Follows facility policy while honoring cultural and religious requirements |
| Medical assistance in dying (MAID) | Legally regulated assisted dying, available in some jurisdictions only | Jurisdiction-specific; nurses follow local law and policy and may have conscience protections |

## Example: Being Present Without Fixing
...
|---|---|---|
| Palliative care | Hospice care | Palliative care relieves suffering at any stage and can run alongside curative treatment; hospice is end-of-life care after curative treatment has stopped |
| Living will | Durable power of attorney for health care | A living will states treatment wishes; a durable POA names a person to decide — they often work together |
| The Kübler-Ross stages | A required sequence | The stages are common responses, not a schedule; people move back and forth, skip, or never "accept" |
| DNR order | "No treatment" | DNR means no CPR; other treatments and comfort care continue |
| Acceptance | Happiness or giving up | Acceptance is a calmer readiness, not joy, and it is not the goal the nurse imposes |
| Grief of the dying person | Grief of the family | Both are real but different; the family's grieving often begins before the death (anticipatory grief) |
...
1. Denial, anger, bargaining, depression, acceptance. The most important limitation: they are descriptive common responses, not a universal or required sequence — expecting a particular stage becomes a way of judging rather than hearing the person.
2. Palliative care relieves suffering at any stage of serious illness, alongside curative treatment; hospice is comfort-focused end-of-life care, typically when curative treatment has stopped. Eligibility and services vary by program and jurisdiction.
3. A living will is a written statement of what treatments the person would or would not want; a durable power of attorney for health care names a specific person to make health care decisions. They are often used together.
4. Reassure accurately: a DNR order means CPR will not be performed if the heart stops; it does not mean other treatments or comfort care stop. The nurse can explain and involve the provider for deeper discussion.
5. Report symptoms and changes to the provider, focus on comfort measures within the plan of care (positioning, mouth care, environment), educate and support the family, document, and honor cultural/religious preferences.
6. Listen and explore the question, do not make promises or take a position, inform the provider and care team, and follow the law and facility policy for the jurisdiction — including conscience protections where they exist. Nurses do not navigate this alone.
...
- Next: [Grief and Loss](02-grief-and-loss.md)
- Related: [Social and Emotional Concerns chapter overview](../README.md)
- Related: [Client Rights and Protections](../chapter-10-legal-and-ethical-guidelines/01-client-rights-and-protections.md)
- Related: [Dementia](../chapter-14-neurocognitive-disorders/03-dementia.md)
