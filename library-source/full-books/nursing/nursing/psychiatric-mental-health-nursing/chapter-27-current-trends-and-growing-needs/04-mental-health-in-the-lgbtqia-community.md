---
title: "Mental Health in the LGBTQIA+ Community"
subject: "Nursing"
...
The LGBTQIA+ community is diverse: lesbian, gay, bisexual, transgender, queer/questioning, intersex, asexual, and many other identities. The letters describe two axes that are often conflated — **sexual orientation** (to whom a person is attracted) and **gender identity** (a person's internal sense of being a man, woman, both, neither, or another gender). A person can be transgender and heterosexual, cisgender and gay, nonbinary and asexual — the combinations are independent. Two more terms matter: **sex assigned at birth** (the label assigned by a clinician, usually based on anatomy) and **gender expression** (how a person presents, which is culturally shaped and does not equal identity).

The mental-health story is a paradox. **LGBTQIA+ identity itself is not a mental illness** — the professional consensus, reflected in the removal of homosexuality from the DSM in 1973 and the reframing of "gender identity disorder" as "gender dysphoria," is that diverse orientations and identities are normal variations of human experience. Yet LGBTQIA+ people, and especially transgender and gender-diverse people, experience higher rates of depression, anxiety, and suicidality than the general population. The leading explanation is **minority stress**: the chronic extra burden of stigma, discrimination, rejection, and vigilance that marginalized groups carry. The clinical implication: what needs treating is often the stress, not the identity.
...
- **Minority stress is modifiable:** social support, family acceptance, affirming care, and community connection measurably reduce the impact of stigma — nurses can be part of the solution.
...
Psychologist Ilan Meyer's **minority stress model** (2003) describes how stigma harms health. **Distal stressors** are external events — discrimination, harassment, violence, rejection. **Proximal stressors** are the internal results — expecting rejection, concealing identity, and internalized stigma (turning society's negative messages against oneself). Chronic stress dysregulates the stress response, raising risk for depression, anxiety, substance use, and physical illness. The model is the dominant framework in LGBTQIA+ health and also explains resilience: when distal stressors are reduced and support is high, outcomes improve — **family acceptance is one of the strongest protective factors for LGBTQIA+ youth**.
...
|---|---|---|
| Sexual orientation | To whom a person is attracted (gay, lesbian, bisexual, asexual, etc.). | One axis of identity; unrelated to gender identity. |
| Gender identity | A person's internal sense of their own gender. | The basis of transgender/cisgender/nonbinary terms. |
| Transgender | Gender identity differs from the sex assigned at birth. | A common identity; requires respectful, individualized care. |
| Cisgender | Gender identity matches the sex assigned at birth. | The counterpart term; avoids "normal vs. other" framing. |
| Nonbinary | Gender identity outside the man/woman binary. | Often invisible in forms and language; inclusive intake matters. |
| Gender dysphoria | Clinically significant distress from the mismatch between identity and assigned sex. | The current DSM label — distress, not identity, is the focus. |
| Minority stress | Chronic stress from stigma, discrimination, and vigilance. | The leading explanation for LGBTQIA+ mental-health disparities. |
| Internalized stigma | Turning society's negative messages about one's identity against oneself. | A proximal stressor that worsens depression and delays care. |
| Distal vs. proximal stressors | External events vs. internal responses to them. | The two layers of minority stress; each responds to different supports. |
| Affirming care | Care that respects and validates identity in language, assessment, and treatment. | Improves trust, disclosure, and mental-health outcomes. |

## Example: The Intake Form and the Quiet Teenager
...
1. Explain the difference between sexual orientation and gender identity, with an example.
2. What is the minority stress model, and how does it explain mental-health disparities in the LGBTQIA+ community?
3. Why is "gender dysphoria" the current diagnostic label rather than "gender identity disorder"?
4. A transgender patient tells you their family rejected them and they are having thoughts of suicide. What do you do?
5. A minor patient asks you to keep their identity secret from their parents. What determines what you can promise?
6. Give three concrete examples of affirming nursing care.

<details>
<summary>Show answers</summary>

1. Sexual orientation is attraction (to whom); gender identity is internal sense of gender (who one is). Example: a transgender woman (identity) can be attracted to women (lesbian orientation) — the two axes are independent.
2. Distal stressors (discrimination, harassment, violence, rejection) plus proximal stressors (expecting rejection, concealing identity, internalized stigma) produce chronic stress that raises rates of depression, anxiety, substance use, and suicidality. Identity is not the cause; stigma is.
...
4. Recognize the warning signs, stay with the person, and escalate immediately to the provider and crisis team per facility policy — team-based crisis response, no solo intervention. Nonjudgmental presence and affirming language are part of the response.
5. Jurisdiction and facility policy. Laws about minor consent, parental notification, and confidentiality vary; the nurse must know the applicable law and policy and act within them, being honest with the patient about what can and cannot be kept confidential.
6. Examples: ask and use chosen name/pronouns consistently; use inclusive intake forms and neutral relationship language; ask rather than assume; explain before touching; offer family-support resources; screen for depression and suicidality without stigma.

</details>

## Related Topics

- Previous: [PTSD and Veteran Trauma](03-ptsd-and-veteran-trauma.md)
- Next: [Mental Health in the Homeless and Displaced Population](05-mental-health-in-the-homeless-and-displaced-population.md)
- Related: [Diversity, Equity, and Inclusion](../chapter-08-cultural-considerations/04-diversity-equity-and-inclusion.md) · [Gender Dysphoria](../chapter-22-sexual-dysfunction-and-gender-dysphoria/03-gender-dysphoria.md) · [Self-Harm and Suicide](../chapter-16-mood-disorders-and-suicide/03-self-harm-and-suicide.md) · [Current Trends and Growing Needs chapter overview](../README.md)
...
- Safety notes: Educational content only. Confidentiality and consent laws for minors vary substantially by jurisdiction — verify local law and facility policy before acting or promising. Statistics on disparities should be verified against current sources. Gender-affirming treatments are prescribed and managed by providers; nursing scope is supportive per orders and policy. Language in this area evolves; follow current professional guidance.
