...
Between full inpatient care and ordinary office visits lies a spectrum of **stepped care**. A **partial hospitalization program (PHP)** provides structured treatment during the day — groups, therapy, medication monitoring, skill building — while the person sleeps at home. An **intensive outpatient program (IOP)** provides fewer hours of structured programming. PHPs and IOPs serve both as step-downs from inpatient care and as step-ups when a person is deteriorating but does not need 24-hour supervision. The choice of level is a clinical decision made by the treatment team, informed by risk and stability, and varies with what programs exist locally.
...
|---|---|---|
| Continued support | Organized services that keep care going after discharge from acute treatment | Without it, treatment gains unravel; it is the bridge from hospital to community |
| Deinstitutionalization | The mid-twentieth-century shift of people with serious mental illness out of large state hospitals into the community | Explains both the promise and the gaps in community mental health care today |
| Discharge planning | The process, starting at admission, of preparing a person to leave the hospital safely | Poor planning is a leading cause of preventable readmission |
| Case management | Coordination of a person's services and practical needs by a single point of contact | Keeps a fragmented system navigable for people with complex needs |
| Assertive community treatment (ACT) | Intensive, multidisciplinary, in-the-community team care with small caseloads and no time limit | The highest-intensity community support; grew from Stein and Test's 1970s experiment |
| Partial hospitalization program (PHP) | Structured daytime treatment with the person sleeping at home | A step-down from inpatient care or step-up from office visits |
| Intensive outpatient program (IOP) | Structured treatment for fewer hours per week than a PHP | Fills the middle of the stepped-care continuum |
| Peer support specialist | A trained person with lived experience of mental health conditions who supports others | Adds hope and practical connection; complements, never replaces, clinical care |
| Warm handoff | Directly introducing the person to the next provider or service | Reduces the chance of disconnection at transitions |
...
1. Why did deinstitutionalization create the need for formal "continued support" services?
2. What were the key design features of Stein and Test's Training in Community Living program, and what did the early findings show?
3. How do a partial hospitalization program and an intensive outpatient program differ?
4. Why is peer support described as complementing rather than replacing professional treatment?
5. When a person in continued support expresses thoughts of self-harm, what is the nurse's role?
6. What makes a discharge plan concrete rather than a wish list?

<details>
<summary>Show answers</summary>

1. Deinstitutionalization moved people out of large state hospitals into communities whose support services were often underfunded and fragmented, leaving a gap between hospital and community that continued-support services exist to close.
...
3. PHP provides structured daytime treatment with the person sleeping at home; IOP provides fewer hours of structured programming per week. Both are stepped levels between inpatient care and ordinary outpatient visits.
4. Peer support offers lived-experience connection and hope, which is valuable, but it is not licensed clinical treatment; it works alongside professional care.
5. Recognition and escalation: stay with the person, notify the provider, and follow facility policy — never attempt to manage the crisis alone.
6. It names a specific provider, a scheduled date, transportation and other access arrangements, medication teaching, and a follow-up contact — and the person can explain it back. (Exact steps follow facility policy.)

</details>

## Related Topics

- Previous: [Discharge and Transfer](03-discharge-and-transfer.md)
- Next: [Online Self-Help and Therapy](05-online-self-help-and-therapy.md)
- Related: [Collaboration and Coordination of Care](01-collaboration-and-coordination-of-care.md) · [Recovery and Rehabilitative Needs](02-recovery-and-rehabilitative-needs.md) · [Interprofessional Care chapter overview](../README.md)
