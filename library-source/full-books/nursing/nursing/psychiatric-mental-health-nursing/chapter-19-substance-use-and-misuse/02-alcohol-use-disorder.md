...
- **Withdrawal can be dangerous.** Stopping abruptly after heavy, prolonged use can cause seizures and **delirium tremens (DTs)**, a medical emergency. Recognizing risk early and escalating it is a core nursing responsibility.
...
Person-first phrasing — "a person with alcohol use disorder," not "an alcoholic" — reflects the chronic-illness model and lowers shame. The nurse's role includes screening, objective documentation ("reports drinking six beers daily," not "patient is a drunk"), education, and referral within facility policy and scope. **Motivational interviewing** — open questions and reflection rather than lecturing — supports change more effectively than scare tactics.
...
|---|---|---|
| Alcohol use disorder (AUD) | A diagnosable pattern of alcohol use causing significant impairment, spanning mild to severe | The current diagnostic label; replaces stigmatizing terms like "alcoholism" |
| Tolerance | Needing more alcohol to get the same effect | Signals brain adaptation; drives escalating use |
| Withdrawal | Physical symptoms when alcohol is stopped after heavy use | Can progress to seizures and DTs — a medical emergency |
| Delirium tremens (DTs) | Severe withdrawal with confusion, hallucinations, and dangerous autonomic instability | Life-threatening; recognition and escalation are critical |
| CAGE questionnaire | Four screening questions (Cut down, Annoyed, Guilty, Eye-opener) | Quick, memorable screen; positive answers warrant full assessment |
| Physical dependence | The body's adapted state where stopping triggers withdrawal | Distinct from addiction; can occur with prescribed or socially accepted use |
| Motivational interviewing | A communication style that draws out a person's own reasons for change | More effective than lecturing; core nursing communication skill |

## Example: A surgical admission that starts with a question
...
1. Name the four DSM-5 criterion groups for alcohol use disorder.
2. What does CAGE stand for, and what is its purpose?
3. Why is abrupt cessation after heavy, prolonged use dangerous?
4. What signs suggest delirium tremens, and what should you do?
5. Why does person-first language matter in substance use care?

<details>
<summary>Show answers</summary>

1. Impaired control, social impairment, risky use, and pharmacological changes (tolerance/withdrawal).
2. Cut down, Annoyed, Guilty, Eye-opener — a brief screen that flags possible alcohol problems for further assessment; it does not diagnose.
3. The brain has adapted to alcohol's depressant effects; removing it abruptly triggers a rebound (withdrawal) that can include seizures and delirium tremens.
4. Confusion, hallucinations, tremor, sweating, racing heart, and unstable vital signs. Treat as a medical emergency: stay with the person, ensure safety, and activate the provider/rapid-response process per facility policy — do not manage withdrawal independently.
5. Labels like "alcoholic" carry shame that discourages disclosure and care-seeking; person-first language reflects the chronic-illness model and supports a therapeutic relationship.

</details>

## Related Topics

- Previous: [Substance Use Disorders](01-substance-use-disorders.md)
- Next: [Stimulant Use Disorders](03-stimulant-use-disorders.md)
- Related: [Dealing with Addiction](05-dealing-with-addiction.md)
- Related: [Substance Use and Misuse chapter overview](../README.md)
...
- Review flags: binge/heavy-drinking quantity definitions (NIAAA commonly cited), DSM-5 severity cutoffs, and lab markers (GGT/MCV/CDT) should be verified against current program references and the current DSM edition.
