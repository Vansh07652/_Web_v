...
Alcohol use exists on a spectrum — from low-risk drinking, to risky patterns, to alcohol use disorder. In older adults, the concern is not simply how much a person drinks but how alcohol affects a body changed by age: the same glass of wine that was harmless at 40 can cause falls, confusion, and medication problems at 75.
...
- **Lower body water.** Older adults have proportionally less body water, so the same drink produces a higher blood alcohol concentration.
...
Standard screening tools include the **CAGE questionnaire** (Cut down, Annoyed by criticism, Guilty, Eye-opener), the **AUDIT** (Alcohol Use Disorders Identification Test), and the **SMAST-G** (Short Michigan Alcoholism Screening Test — Geriatric version), adapted specifically for older adults. Screens are brief, structured question sets that flag risk and guide conversation — they do not diagnose.
...
A person who has been drinking heavily and stops abruptly — or is hospitalized and cannot drink — can develop **alcohol withdrawal**, which in older adults can be severe and life-threatening: tremor, sweating, and anxiety progressing to elevated heart rate and blood pressure, seizures, and **delirium tremens** (confusion, hallucinations, agitation, autonomic instability).
...
|---|---|---|
| Alcohol use disorder | A pattern of drinking that causes clinically significant impairment or distress | The diagnostic-level end of the alcohol spectrum; treatable at any age |
| Blood alcohol concentration | Amount of alcohol in the blood | Rises higher in older adults for the same drink because body water is lower |
| Early-onset alcohol problems | Heavy drinking that began earlier in life | Long-standing pattern with accumulated health effects |
| Late-onset alcohol problems | Drinking that begins or escalates after ~65, often after losses | Easily missed because there is no "history"; often stress-related |
| CAGE | Four-question screen: Cut down, Annoyed, Guilty, Eye-opener | Quick, widely used risk flag |
| AUDIT | Alcohol Use Disorders Identification Test | More detailed screening; used internationally |
| SMAST-G | Short Michigan Alcoholism Screening Test — Geriatric version | Adapted for older adults; catches subtler, late-onset presentations |
| Alcohol withdrawal | Physical syndrome when heavy drinking stops abruptly (tremor, elevated vitals, seizures, delirium tremens) | Can be severe and life-threatening in older adults — escalate to provider |
| Delirium tremens | Severe withdrawal with confusion, hallucinations, agitation, autonomic instability | A medical emergency requiring immediate provider-directed care |
| MAST | Michigan Alcoholism Screening Test (Selzer, 1971) | Landmark early screening tool; made detection systematic |

## Example: Mr. Nguyen's falls
...
|---|---|---|
| Alcohol problems in older adults | Rare or only in "down-and-out" drinkers | They are common, often invisible, and can occur in anyone — including late-onset after losses |
| "Just a glass of wine at night" | Low risk for that person | With less body water, slower metabolism, medications, and fall risk, the same drink is riskier in later life |
| Falls/confusion in an older drinker | "Just aging" | Falls, confusion, and depression may be alcohol-related — ask about drinking |
| Early-onset vs. late-onset patterns | One "type" of drinker | Both patterns exist; late-onset is easily missed without a history |
| Screening tool result | Diagnosis | CAGE/AUDIT/SMAST-G flag risk for conversation and evaluation; diagnosis is a clinician's job |
| Asking about alcohol | Accusing or judging | Routine, normalized, private questions reduce stigma and improve detection |
| Stopping drinking abruptly on one's own | Safe for heavy drinkers | Abrupt withdrawal can be dangerous (seizures, delirium tremens) — withdrawal is provider-managed |
| "Alcoholic" (label) | Person with alcohol use disorder | Person-first language reduces stigma and supports treatment |
...
1. Any three of: lower body water (higher blood alcohol concentration per drink), slower liver metabolism (longer-lasting effects), increased brain sensitivity, medication interactions, greater vulnerability to falls and injury.
2. Early-onset (heavy drinking that began earlier in life) and late-onset (begins or escalates after ~65, often after losses). Late-onset is missed because there is no prior "history" and the person may not fit stereotypes.
3. Any four of: falls/fractures, confusion or memory problems, depression/anxiety, insomnia, malnutrition/weight loss, GI symptoms or bleeding, family reports of behavior change.
4. CAGE and AUDIT are general screening tools; SMAST-G is adapted specifically for older adults, designed to catch subtler and late-onset presentations that general tools may miss.
5. Because an older body is more sensitive to alcohol and more vulnerable to complications — withdrawal can progress to seizures and delirium tremens. The nurse identifies risk, notifies the provider, and follows facility policy; withdrawal assessment and medication are provider-directed.
6. "I ask every patient about alcohol, just like tobacco, because it affects so many things — about how much and how often you drink?" — asked privately, matter-of-factly, without judgment.

</details>

## Related Topics

- Previous: [Delirium](04-delirium.md)
- Next: [Pain](06-pain.md)
- Related: [Depression](02-depression.md), [Anxiety](03-anxiety.md), [Healthcare Concerns and Decisions of Older Adults](01-healthcare-concerns-and-decisions-of-older-adults.md)
- Chapter overview: [Older Adults](../README.md)
- Cross-chapter: [Substance Use and Misuse](../chapter-19-substance-use-and-misuse/README.md)
