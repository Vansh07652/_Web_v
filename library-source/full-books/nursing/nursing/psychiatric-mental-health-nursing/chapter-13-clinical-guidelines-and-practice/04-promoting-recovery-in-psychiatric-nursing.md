---
title: "Promoting Recovery in Psychiatric Nursing"
subject: "Nursing"
...
> **Chapter:** [Chapter 13: Clinical Guidelines and Practice](../README.md)  
> **Topic:** 4  
> **Source structure:** OpenStax public textbook outline

## Overview

The recovery model is a philosophy of mental health care that shifts the goal from *curing* or *managing symptoms* to supporting each person in building a meaningful, satisfying life — with or without ongoing symptoms. Recovery is personal and defined by the person themselves: it may mean returning to work, rebuilding relationships, finding purpose, or simply living with more hope and control. It is not the same as "symptom-free," and it is not a straight line — setbacks are expected parts of the journey, not failures.

Recovery-oriented psychiatric nursing is the practical expression of this philosophy: instilling hope, strengths-based assessment, shared decision-making, peer connections, self-management tools, and treating the client as the expert on their own life. The nurse does not "give" the client recovery — the nurse walks alongside, believes in the person's capacity, and removes barriers. This topic is the capstone of the chapter's clinical guidelines because it reframes everything else: guidelines, standards, diagnoses, and care plans all exist to serve the person's own recovery, not the other way around.
...
Two widely used frameworks organize the ideas. **SAMHSA's framework** (U.S. Substance Abuse and Mental Health Services Administration) defines recovery as "a process of change through which individuals improve their health and wellness, live self-directed lives, and strive to reach their full potential," with guiding principles: hope is central; recovery is person-driven and occurs via many pathways; it is holistic (mind, body, spirit, and community); it is supported by peers, allies, and relationships; it is culturally embedded; it addresses trauma; and it involves strengths, responsibility, and respect. The **CHIME framework** comes from a systematic review of recovery research (Leamy and colleagues, 2011), which found five recurring elements: **C**onnectedness, **H**ope and optimism about the future, **I**dentity (a positive sense of self beyond illness), **M**eaning and purpose, and **E**mpowerment. Both give the nurse a practical checklist: does this care plan build connection, hope, identity, meaning, and power for this person?

### What recovery-oriented nursing looks like in practice

Concretely, the recovery-oriented nurse: uses **strengths-based assessment** ("What are you good at? What has helped you before?") alongside problem identification; communicates **hope honestly** — believing in the person's future without false promises; practices **shared decision-making**, presenting options and letting the client weigh in on goals and approaches; supports **peer support** — connecting clients with people who have lived experience, because hope is often most believable from someone who has been there; introduces **self-management tools** such as the Wellness Recovery Action Plan (WRAP), a widely used, person-designed planning process for staying well; and coordinates **community integration** — housing, work, school, relationships — because recovery happens in life, not only in treatment settings.
...
|---|---|---|
| Recovery model | A philosophy in which care supports the person's own meaningful life, with or without ongoing symptoms. | Reframes the goal of care from symptom management to the person's life and goals. |
| Medical model | A framework focused on identifying and treating illness or symptoms. | Useful for diagnosis and treatment, but incomplete without the person's goals and context. |
| Hope | Belief in a meaningful future, communicated honestly. | The engine of recovery; hope from clinicians and peers sustains the process. |
| Person-driven | The person directs their own goals, choices, and pathway. | Keeps care accountable to the person's life, not the system's convenience. |
| Strengths-based assessment | Identifying a person's assets, skills, and past successes alongside problems. | Reveals the resources recovery can build on. |
| Shared decision-making | Clinician and client make care decisions together, with the client's values weighing equally. | Improves engagement and honors self-determination. |
| Peer support | Support from people with lived experience of mental health conditions. | Hope and practical wisdom are often most credible from someone who has been there. |
| WRAP | Wellness Recovery Action Plan — a person-designed planning tool for staying well. | Gives the person a practical, self-directed structure for wellness. |
| CHIME | Connectedness, Hope, Identity, Meaning, Empowerment — recovery elements from a systematic review. | A research-based checklist for whether care is actually recovery-oriented. |
| Deinstitutionalization | The mid-20th-century shift of people from large psychiatric hospitals into communities. | Explains both the recovery movement and today's gaps in community mental health care. |

## Example: Two Approaches to the Same Client
...
|---|---|---|
| Recovery | Cure / being symptom-free | Recovery is a meaningful life with or without symptoms; cure is symptom elimination. Many people recover without a cure. |
...
| Honest hope | False reassurance | "I believe your future can be better, and here's evidence and support" is honest; "Don't worry, everything will be fine" is empty. |
| Person-driven care | The nurse does nothing | Person-driven means the person directs goals; the nurse remains active as coach, connector, and safety guardian. |
| Peer support | Unprofessional care | Peer support is a trained, evidence-informed role by people with lived experience, working within the team. |
| Respecting choices | Ignoring danger | Self-determination holds unless there is immediate danger, when safety policy and the provider take over — transparently and temporarily. |
| Setbacks | Failure of recovery | Recovery is nonlinear; setbacks are part of the process, not proof the person cannot recover. |
...
2. Deinstitutionalization (the large-scale movement from hospitals to communities), the failures of institutional care, longitudinal research showing substantial long-term improvement, and the consumer/survivor/ex-patient movement's demand for voice and rights.
3. Connectedness, Hope, Identity, Meaning, Empowerment — recovery elements found across the research literature. A nurse can use it as a checklist: does this care plan strengthen the client's connections, hope, positive identity, sense of purpose, and control?
4. Examples: strengths-based assessment ("What's helped you before?"); shared decision-making about goals; connecting the client with peer support; teaching self-management tools like WRAP; focusing on community integration (housing, work, relationships); using person-first language.
5. With honest hope: acknowledge the client's experience, share that long-term studies show substantial improvement and recovery are real and common, and offer concrete supports (peer support, planning tools) — without false promises.
6. No. Recovery-oriented care respects self-determination within safety limits: when a client is in immediate danger, the nurse follows facility policy and involves the provider — transparently and respectfully — and works to restore the client's control as soon as safety allows. Safety and recovery are both non-negotiable.

</details>

## Related Topics

- Previous: [Nursing Assessment and Care Plans](03-nursing-assessment-and-care-plans.md)
- Next: [Special Considerations for PMH Practice](05-special-considerations-for-pmh-practice.md)
- Related: [Clinical Guidelines and Standards](01-clinical-guidelines-and-standards.md) · [DSM-5 Criteria and Use](02-dsm-5-criteria-and-use.md)
- [Clinical Guidelines and Practice chapter overview](../README.md)
