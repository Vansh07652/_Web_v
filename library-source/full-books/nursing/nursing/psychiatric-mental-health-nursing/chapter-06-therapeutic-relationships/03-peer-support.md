...
**Peer support** is help grounded in shared lived experience: people who have faced mental health challenges — and who are themselves in recovery — supporting others who are facing them now. Peer support specialists (also called peer workers, peer navigators, or recovery coaches) are trained, often certified professionals whose qualification is lived experience plus formal training. Their work rests on mutuality: not "I will fix you," but "I have been where you are, and recovery is possible."
...
|---|---|---|
| Peer support | Help grounded in shared lived experience of mental health challenges and recovery | The topic's core: mutuality, hope, and modeling recovery |
| Peer support specialist | A trained, often certified worker whose qualification is lived experience | The professional peer role, increasingly embedded in teams |
| Lived experience | Personal experience of mental health challenges and recovery | The credential that clinicians do not have |
| Mutuality | A relationship of equals sharing experience | The defining difference from the clinician–client relationship |
| Peer-run organization | A program run by and for people with lived experience | Keeps peer values such as choice and dignity central |
| Warm line | Phone support for everyday struggles — not a crisis line | Low-barrier connection before problems escalate |
| Mutual-help group | A self-led group of people sharing a condition or goal | AA, NAMI Connection, DBSA, SMART Recovery, and others |
| Recovery-oriented care | Care that defines recovery by the person's own goals | The philosophy that makes peer expertise valuable |
| Dual relationship | When the peer worker also has another connection to the person (friend, neighbor) | A boundary issue handled by transparency and policy |
| SAMHSA | US federal agency; published national peer-support practice guidelines (2013) | A reference point for the formalized peer role |
...
|---|---|---|
| Peer support | Psychotherapy | Peer support shares experience and hope; therapy uses trained clinical methods to treat |
| Peer specialist | Case manager | Peers model recovery and provide emotional support; case managers coordinate services — different training and functions |
| Peer support | Friendship | Peer support is a structured role with training, boundaries, and confidentiality — not casual friendship |
| Warm line | Crisis line | Warm lines are for everyday support; crisis lines (and 911) handle imminent danger |
| Sharing one's story | Oversharing | Purposeful, bounded disclosure serves the client; indiscriminate disclosure burdens them |
| Peer advice on medication | Medication teaching | Peers never advise on medications; that is the clinician's role — peers can support the person in talking to the provider |
...
1. Peer support is grounded in shared lived experience and mutuality — the specialist models recovery and offers hope and practical guidance; it is not diagnosis, treatment, or case management.
2. From mutual-help traditions (AA, 1935), the ex-patient and psychiatric survivor movement of the 1960s–70s, and the formalization of peer roles in the 1990s onward as recovery-oriented care grew.
3. The advice exceeds the peer scope (no medication advice) and wrongly generalizes one person's experience. The peer specialist should encourage the client to discuss concerns with the provider and should raise the conversation with the team; supervisors and policy should support role clarity.
4. That peer support is generally safe and comparable to usual care, with modest benefits on outcomes like hope and empowerment in some studies — but the evidence is heterogeneous, so effects vary.
5. Clarify the roles: the peer specialist shares lived experience and supports recovery; the therapist and other clinicians provide treatment. Both are valuable, and the client can use both.
6. Because peer roles are defined by certification, employer policy, funding, and jurisdiction — all of which differ; nurses should check local policy rather than assume a uniform scope.

</details>

## Related Topics

- Previous: [Family Dynamics](02-family-dynamics.md)
- Next: [Client Engagement](04-client-engagement.md)
- Related: [Nurse-Client Relationship](01-nurse-client-relationship.md) · [Trauma-Informed Care](05-trauma-informed-care.md) · [Therapeutic Relationships chapter overview](../README.md)
