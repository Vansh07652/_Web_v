---
title: "People Who Are Experiencing Homelessness"
subject: "Nursing"
...
**People who are experiencing homelessness** are a population — not a diagnosis, not a lifestyle, and not a single type of person. The term describes people who lack a stable, safe, adequate place to sleep: outside (unsheltered), in an emergency shelter, or temporarily "doubled up" on someone's couch or floor. Homelessness is a **social determinant of health**: being unhoused exposes people to the elements, violence, and infection while stripping away the stability needed to manage health — a place to store medication, cook food, sleep, or recover.
...
Definitions shape who gets counted and served. **Literally homeless** people live in shelters or places not meant for human habitation (streets, cars, abandoned buildings). People who are **doubled up** — staying temporarily with friends or family — are unstably housed but often invisible in official counts. Agencies count people on a single night (**point-in-time count**) and through service data, but every method undercounts, and definitions vary by jurisdiction. For the nurse, homelessness is a spectrum of housing instability, and people on that spectrum are often missed by systems built around stable addresses.
...
|---|---|---|
| Person-first language | Referring to the person before the circumstance ("people experiencing homelessness") | Respects dignity and avoids defining someone by housing status |
| Literally homeless | Living in shelters or places not meant for human habitation | The most visible group in counts and most exposed to the elements |
| Doubled up | Staying temporarily with friends or family because of housing loss | A large, often invisible group of unstably housed people |
| Point-in-time count | A single-night census of people experiencing homelessness | The common measurement method, though every method undercounts |
| Competing priorities | Survival needs outranking health care in daily life | Explains missed appointments; drives low-barrier service design |
| Low-barrier services | Care with minimal requirements: no appointment, no ID requirement, no judgment | Removes the obstacles that keep unhoused people from care |
| Housing First | Providing permanent housing quickly, without preconditions, then adding services | An evidence-informed approach to ending homelessness; availability varies |
| Harm reduction | Practical strategies that reduce harm from substance use without demanding abstinence | Builds trust and reduces death and disease; what is legal varies by jurisdiction |
| Street medicine | Health care delivered directly to people living outside | Reaches people who will never enter a clinic or waiting room |
| Medical respite | A safe place to recover after illness or hospitalization | Prevents discharge "to the street" and costly readmissions |

## Example: Meeting Marcus at the Bus Station
...
1. Why is housing considered a social determinant of health rather than just a living arrangement?
2. What is the difference between someone who is "literally homeless" and someone who is "doubled up," and why does it matter for counting?
3. Explain the concept of competing priorities and give one example of a service design that responds to it.
4. What is Housing First, and how does it differ from a treatment-first approach?
5. Why is person-first language a clinical and ethical issue rather than just politeness?
6. Name three barriers to care a person experiencing homelessness commonly faces and one nursing action that reduces each.

<details>
<summary>Show answers</summary>

1. Because a home is the platform for everything else: medication storage and refrigeration, food preparation, sleep, temperature control, sanitation, safety, and an address that unlocks mail, benefits, and follow-up care. Lose housing and all of these collapse at once.
2. "Literally homeless" people live in shelters or places not meant for habitation and are usually visible in counts; "doubled up" people stay temporarily with friends or family and are frequently missed — so counts understate the true scope of instability.
3. Competing priorities means survival needs (food, a safe place to sleep) outrank health appointments, so missed care is rational, not willful. Walk-in clinics, street outreach, and same-day services are low-barrier responses.
4. Housing First provides permanent housing quickly without requiring sobriety or treatment first, then wraps services around the person. Treatment-first models make housing conditional on "readiness," keeping people on the street while they wait.
5. Language shapes perception and treatment: labeling people "the homeless" reduces them to a stereotype and invites judgment; person-first language supports dignity, trust, and care that addresses the person rather than the label.
6. Examples: no identification (connect with case management to replace it), no transportation or fixed address (outreach and same-day care), and fear of judgment (trauma-informed, consistent engagement). Many valid combinations exist.
...
- Next: [Veterans](02-veterans.md)
- Related: [People with Disabilities](05-people-with-disabilities.md)
...
- Safety note: Educational draft only — no statistics, treatment protocols, or program recommendations are provided here; verify prevalence data and program availability against current sources and local jurisdiction before use.
