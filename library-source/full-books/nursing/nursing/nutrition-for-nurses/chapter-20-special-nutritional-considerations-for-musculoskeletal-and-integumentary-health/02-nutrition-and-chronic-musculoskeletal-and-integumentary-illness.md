---
title: "Nutrition and Chronic Musculoskeletal and Integumentary Illness"
subject: "Nursing"
...
> **Chapter:** [Chapter 20: Special Nutritional Considerations for Musculoskeletal and Integumentary Health](../README.md)  
> **Topic:** 2  
...
Evidence about diet and chronic disease is often suggestive rather than conclusive and changes as research evolves. Some popular claims — that a single food cures arthritis or a supplement reverses osteoporosis — are unsupported, and some supplements interact with medications or cause harm. The nurse's disciplined approach: teach general, defensible concepts; help people recognize reliable nutrition information; flag popular claims for scrutiny; and route individualized assessment and medical nutrition therapy to the registered dietitian (RD) and provider. This guide describes general concepts, not specific diets or doses — those belong to the treating team.
...
|---|---|---|
| Adjunct | Something added to support the main treatment, not replace it | Defines nutrition's honest role in chronic illness |
| Osteoporosis | Chronic loss of bone mass and strength | Raises fracture risk; nutrition supports maintenance |
| Osteoarthritis | Wear-and-tear joint disease | Joint load links directly to body weight |
| Inflammatory arthritis | Immune-driven joint inflammation (e.g., rheumatoid arthritis) | Research frontier; nutrition claims need scrutiny |
| Pressure injury | Localized skin/tissue damage from pressure | Healing is highly nutrition-dependent |
| Malnutrition | Poor nutrition status from inadequate intake or increased needs | Major risk factor for wounds and poor healing |
| Medical nutrition therapy | Individualized nutrition treatment designed by an RD | The scoped route for therapeutic diets and supplements |

## Example: Mrs. Alvarez's Two Problems
...
1. Why is body weight a nutrition-related factor in osteoarthritis?
2. Which general nutrients support wound and pressure injury healing?
3. A person with rheumatoid arthritis asks whether an omega-3 supplement will cure their disease. How should the nurse respond?
4. What is the "illness-to-nutrition feedback loop," and how does the nurse interrupt it?
5. Why must supplement use be discussed with the provider rather than recommended by the nurse?

<details>
<summary>Show answers</summary>

1. Body weight directly influences the load carried by weight-bearing joints; for people with excess weight, gradual, sustainable weight management can reduce joint strain.
2. Protein, calories, vitamin C (collagen formation), zinc, and hydration — always individualized, with the RD assessing actual needs.
3. Acknowledge the interest, explain that evidence is evolving and mixed, note that nutrition is an adjunct rather than a cure, and encourage discussing supplements with the provider — they can interact with medications. Offer no dose or guarantee.
4. Illness reduces intake (pain, fatigue, disability, medications), poor intake worsens healing and strength, and the decline worsens illness. The nurse interrupts it by screening intake and weight and referring to the RD, provider, and community resources.
5. Supplements can interact with medications and cause harm at wrong doses; dosing decisions belong to the provider and RD, and the nurse never improvises recommendations.

</details>

## Related Topics

- Previous: [The Impact of Nutrition on Musculoskeletal and Integumentary Wellness Across the Lifespan](01-the-impact-of-nutrition-on-musculoskeletal-and-integumentary-wellness-across-the-lifespan.md)
- Next: [Treatments and Nutrition](03-treatments-and-nutrition.md)
- Related: [Special Nutritional Considerations for Musculoskeletal and Integumentary Health chapter overview](../README.md)
