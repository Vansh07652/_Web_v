---
title: "Monitoring the Person in Labor for Complications Developing During the Process of Labor and Birth"
subject: "Nursing"
...
> **Chapter:** [Chapter 19: Complications of Labor and Birth](../README.md)  
> **Topic:** 10  
...
|---|---|---|
| Intermittent auscultation | Listening to the fetal heart at set intervals with a Doppler or fetoscope | Valid monitoring method; the interval and response rules follow guidelines |
| Electronic fetal monitoring (EFM) | Continuous tracing of fetal heart rate and contractions | The raw data for detecting decelerations and variability changes |
| Baseline | The average fetal heart rate between contractions/accelerations | A shift in baseline can signal fetal stress |
| Variability | Beat-to-beat fluctuation in the fetal heart rate | Reduced variability can indicate fetal compromise (or sleep, medications) |
| Early deceleration | FHR dip that mirrors the contraction (head compression) | Generally benign |
| Late deceleration | FHR dip that begins after the contraction peaks | Suggests uteroplacental insufficiency; worrisome |
| Variable deceleration | Abrupt, V-shaped FHR dip (cord compression) | Common during pushing; evaluate recovery and trend |
| Tachysystole | Too many contractions / insufficient relaxation between them | Can compromise fetal oxygenation; definition follows guidelines |
| Meconium-stained fluid | Amniotic fluid colored by fetal stool | May indicate fetal stress; aspiration risk to newborn |
| SBAR | Situation, Background, Assessment, Recommendation | Structured handoff/escalation format |

## Example: Reading a trend, not a moment
...
1. What are the four components used to describe a fetal heart rate tracing?
2. Which deceleration type mirrors the contraction and is generally considered benign?
3. A laboring person's temperature rises and the fetal baseline increases. What complication should the nurse suspect?
4. Why is resting tone between contractions clinically important?
5. What does the "B" in SBAR stand for, and why does it matter?
6. Name three findings that require immediate escalation to the provider.

<details>
<summary>Show answers</summary>

1. Baseline rate, baseline variability, accelerations, and decelerations.
2. Early decelerations (head compression); they mirror the contraction and are generally benign.
3. Intra-amniotic infection (chorioamnionitis) — especially with prolonged rupture of membranes; fever plus fetal tachycardia is the classic combination.
4. The fetus depends on uterine relaxation between contractions for blood flow; poor relaxation (tachysystole, high resting tone) can compromise oxygenation.
5. Background — the context (e.g., rupture-of-membranes time, risk factors) that makes the current finding interpretable; without context, numbers are ambiguous.
6. Examples: bright red vaginal bleeding, sudden severe constant pain, fever, severe headache with visual changes, chest pain/difficulty breathing, seizures, worsening FHR pattern. (Facility policy defines the exact chain of command.)

</details>

## Related Topics

- Previous: [Complications in the Third Stage of Labor](09-complications-in-the-third-stage-of-labor.md)
- Related: [Labor Dystocia](01-labor-dystocia.md) · [Medical Interventions During Labor](02-medical-interventions-during-labor.md) · [Obstetrical Conditions Affecting Labor and Birth](03-obstetrical-conditions-affecting-labor-and-birth.md) · [Obstetrical Emergencies](07-obstetrical-emergencies.md)
- Chapter overview: [Complications of Labor and Birth](../README.md)
...
- Content type: Original educational study guide based on OpenStax outline structure. Educational draft: monitoring techniques, definitions (including tachysystole and FHR category thresholds), and response protocols vary by professional organization and facility; verify against current guidelines. FHR interpretation requires formal training; this guide teaches vocabulary only.
