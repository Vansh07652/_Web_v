---
title: "Physiological Adaptation and Transition"
subject: "Nursing"
...
- **Ductus venosus** connects the umbilical vein to the inferior vena cava, shunting blood past the liver. With cord clamping, flow through it ceases almost immediately and it closes functionally within the first days.
- **Foramen ovale** is the opening between the right and left atria. In the womb, pressure is higher on the right side, so blood flows right-to-left, bypassing the lungs. With the first breaths, blood flow through the lungs increases, left atrial pressure rises, and the flap valve is pushed shut — functional closure within the first minutes to hours.
- **Ductus arteriosus** connects the pulmonary artery to the aorta, shunting blood away from the lungs. The rising blood oxygen after the first breaths triggers constriction of its muscular wall; functional closure typically occurs within the first hours to days, with anatomic closure over the following weeks.
...
- **First period of reactivity (first ~30–60 minutes):** the newborn is alert, active, and curious — eyes open, rooting, sometimes with a transiently fast heart rate and rapid, irregular breathing. This is the ideal time for the first assessment, Apgar scoring, early skin-to-skin contact, and feeding attempts.
...
|---|---|---|
| Surfactant | A lung-produced substance that lowers surface tension so air sacs stay open | Enables the first breaths to succeed; preterm infants often lack enough of it |
| Ductus venosus | Fetal shunt from the umbilical vein past the liver | Closes with cord clamping; part of the switch from placental to liver circulation |
| Foramen ovale | Fetal opening between the right and left atria | Closes functionally with the first breaths as left atrial pressure rises |
| Ductus arteriosus | Fetal vessel connecting pulmonary artery to aorta | Constricts as blood oxygen rises after birth; functional closure over hours to days |
| Functional vs. anatomic closure | Closure that stops blood flow (functional) vs. permanent structural sealing (anatomic) | Explains why murmurs can persist transiently after birth |
| First period of reactivity | The alert, active first ~30–60 minutes after birth | Prime window for assessment, skin-to-skin, and first feeding |
| Second period of reactivity | The waking, feeding-interested phase ~2–8 hours after birth | Another key window for feeding support and observation |
| Transition | The coordinated physiologic changes adapting the newborn to extrauterine life | The framework for judging whether a newborn's adaptation is normal |

## Example: The first hour, minute by minute
...
1. What are the three fetal shunts, and what event initiates their functional closure?
2. Why is surfactant especially important for preterm newborns?
3. Describe the three behavioral phases of transition and roughly when each occurs.
4. A nurse hears a soft murmur in a 20-minute-old newborn who is otherwise pink and vigorous. What is the likely explanation, and what should the nurse do?
5. Why does cold stress threaten respiratory and circulatory transition?

<details>
<summary>Show answers</summary>

1. Ductus venosus, foramen ovale, and ductus arteriosus. Cord clamping stops flow through the ductus venosus; lung inflation and the resulting rise in blood oxygen close the foramen ovale and constrict the ductus arteriosus.
2. Surfactant lowers surface tension so alveoli stay open after the first breaths; it is produced in increasing amounts late in pregnancy, so preterm infants often have less and are at higher risk of respiratory difficulty.
3. First period of reactivity (~first 30–60 minutes: alert, active, good time for early assessment and feeding), a sleep/quiet phase (minutes to hours), and second period of reactivity (~2–8 hours: awake, feeding interest, meconium/urine passage).
4. A transient murmur during shunt closure is a common normal finding in an otherwise well newborn; the nurse documents it, continues observation, and reports if the murmur persists or is accompanied by symptoms such as poor feeding or respiratory distress.
5. Cold stress increases oxygen consumption and metabolic demand and can deplete glucose stores, leaving fewer reserves for respiratory and circulatory adaptation — which is why drying, warming, and early feeding protect the transition.

</details>

## Related Topics

- Previous: [Apgar Scoring](01-apgar-scoring.md)
- Next: [Neutral Thermal Environment](03-neutral-thermal-environment.md)
- Related: [Physical Assessment of the Newborn](../chapter-23-newborn-assessment/01-physical-assessment-of-the-newborn.md)
- Chapter overview: [Immediate Care of the Newborn](../README.md)
...
- Safety flags: Timing of shunt closure and transitional findings vary among infants; assessment thresholds follow current neonatal guidelines and institutional policy — verify before clinical use. Educational draft only; not a substitute for training or clinical judgment.
