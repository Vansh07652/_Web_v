...
> **Chapter:** [Chapter 2: Culturally Competent Care](../README.md)  
> **Topic:** 3  
> **Source structure:** OpenStax public textbook outline

## Overview

Health equity means that everyone has a fair and just opportunity to be as healthy as possible. A **health disparity** is a particular type of health difference closely linked with social, economic, or environmental disadvantage. A **health inequity** is a disparity that is avoidable and unfair — the product of systems and policies, not of biology or bad luck.

Why do some groups get sicker and die younger than others? Mostly not because of their genes. The conditions in which people are born, grow, live, work, and age — the **social determinants of health (SDOH)** — shape outcomes more than medical care alone. The U.S. Healthy People framework organizes SDOH into five domains: economic stability, education access and quality, health care access and quality, neighborhood and built environment, and social and community context.
...
- **Health care itself can be part of the problem:** discrimination, including implicit bias, can affect communication, assessment, and decisions at the point of care.
...
- **Exams test the vocabulary and concepts:** equality vs equity, disparity vs inequity, SDOH, health literacy, and implicit bias are standard nursing-education topics.
...
A **disparity** is a measurable difference; an **inequity** is a difference that is avoidable and unfair. Groups that experience disadvantage more often include people with low incomes, racial and ethnic minority groups, rural residents, people with disabilities, LGBTQ+ people, older adults, and people with limited English proficiency. **Intersectionality** matters: overlapping identities — for example, a disabled immigrant with low income — can compound disadvantage. And person-first language applies here: "people with low incomes," "people experiencing homelessness," never labels that reduce a person to a condition.
...
|---|---|---|
| Health equity | A fair and just opportunity for everyone to be as healthy as possible | The goal of equity work and a stated aim of national health objectives |
| Health disparity | A health difference closely linked to social, economic, or environmental disadvantage | Identifies where gaps exist so they can be measured and addressed |
| Health inequity | A disparity that is avoidable and unfair | Names the systemic causes and signals that action is possible and owed |
| Social determinants of health | The conditions of birth, growth, living, working, and aging | The biggest drivers of population health outcomes |
| Health literacy | The ability to obtain, understand, and use health information | Low health literacy is common and linked to worse outcomes |
| Teach-back | Asking the patient to restate the plan in their own words | Verifies understanding instead of assuming it |
| Implicit bias | Unconscious associations that shape behavior | Can distort communication and decisions despite good intentions |
| Vulnerable population | A group at higher risk of poor health due to disadvantage | Focuses advocacy and resources where they are needed |
| Intersectionality | Overlapping identities that compound advantage or disadvantage | Prevents reducing a person to a single label |
| Social needs screening | Asking about food, housing, transportation, and other resource needs | Finds the real-world barriers to following a care plan |

## Example: Teach-back reveals the real problem
...
|---|---|---|
| Equality | Equity | Equality = the same for everyone; equity = what each person needs to reach the same outcome |
| Disparity | Inequity | A disparity is any measurable difference; an inequity is a difference that is avoidable and unfair |
| Race as biology | Race as social construct | Race is a social classification, not a biological cause of health differences |
| Health literacy | General literacy | A person can read well yet struggle with medical jargon, numbers, and instructions |
| Implicit bias | Explicit discrimination | Bias is unconscious and automatic; discrimination is knowingly unequal treatment — each needs different interventions |
| Equal treatment | Equitable treatment | Treating everyone identically can perpetuate gaps; equity tailors support to need |
...
1. Equality gives everyone the same thing; equity gives people what they need to reach the same outcome; justice changes the system so the barrier no longer exists.
2. Economic stability; education access and quality; health care access and quality; neighborhood and built environment; social and community context.
3. A disparity is a measurable difference in health linked to disadvantage; an inequity is a disparity that is avoidable and unfair — caused by systems and policies rather than biology.
4. Because unconscious associations can affect communication and decisions even in well-meaning clinicians. Defenses include self-reflection, structured and standardized assessment tools, deliberately re-checking decisions — plus system-level policies, training, and accountability.
5. Teach-back asks patients to restate the plan in their own words. It is a standard expectation because low health literacy is common and invisible; verifying understanding prevents errors and supports safe self-care.

</details>

## Related Topics

- Previous: [Cultural Assessment](02-cultural-assessment.md)
- Next: End of chapter
- Related: [Concepts in Culture](01-concepts-in-culture.md)
- Related: [Culturally Competent Care chapter overview](../README.md)
