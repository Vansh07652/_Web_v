---
title: "Effective Communication in the Nurse-Patient Relationship"
subject: "Nursing"
...
> **Chapter:** [Chapter 6: Comprehensive Health Assessment and Physical Examination](../README.md)  
> **Topic:** 2  
> **Source structure:** OpenStax public textbook outline

## Overview

Therapeutic communication is the purposeful, goal-directed exchange of information, thoughts, and feelings between a nurse and a patient (and, when appropriate, the patient's family) that supports assessment, education, and healing. It differs from social conversation: the nurse is not chatting for its own sake but is using specific techniques — active listening, open-ended questions, reflection, clarification, and summarizing — to understand the patient's experience and gather the information needed to plan care. Communication in nursing is a clinical skill, not a personality trait; it can be learned, practiced, and improved like any other competency.
...
- **Patient safety:** Miscommunication during handoffs and between team members is a well-documented contributor to adverse events. Structured, complete communication (such as SBAR) reduces the chance that important information is lost when care changes hands.
...
Sensory loss (hearing, vision), language differences, cognitive impairment, pain, fatigue, anxiety, low health literacy, and environmental noise all interfere with communication. Adaptations include: facing the patient, reducing background noise, speaking clearly without shouting, using professional interpreters for important clinical conversations (follow facility policy; family members may filter information or compromise confidentiality), using pictures and plain language, using **teach-back** to check understanding, and allowing extra time. Person-first language — "a person with diabetes" rather than "a diabetic" — reflects the principle that the person is not defined by a diagnosis.
...
|---|---|---|
| Therapeutic communication | Purposeful, goal-directed interaction that supports the patient's care and wellbeing | The core nursing communication skill, tested in practice and on exams |
| Active listening | Giving full, focused attention to what the patient says and means | Builds trust and improves the accuracy of the information gathered |
| Open-ended question | A question that invites description rather than a one-word answer | Elicits a fuller, more accurate picture of the patient's experience |
| Reflection | Repeating or rephrasing the patient's words or feelings back to them | Confirms understanding and shows the patient they were heard |
| SBAR | Situation–Background–Assessment–Recommendation, a structured report format | Reduces information loss when care is transferred between clinicians |
| Congruence | Matching between the verbal message and nonverbal behavior | Incongruent messages confuse patients and undermine trust |
| Teach-back | Asking the patient to explain, in their own words, what they were taught | Verifies understanding instead of assuming it |

## Example: A postoperative conversation
...
1. A patient says, "I'm scared about the surgery tomorrow." Which response is therapeutic: "Oh, you'll be fine — the surgeons are great!" or "Tell me more about what worries you most"?
2. Name three nonverbal cues a nurse should monitor during an interaction.
3. What is the difference between restatement and clarification?
4. Why is silence sometimes the right choice during an interview?
5. List the four components of SBAR.
6. Why should a professional interpreter, rather than a family member, be used for an important clinical conversation?

<details>
<summary>Show answers</summary>

1. "Tell me more about what worries you most" — it invites the patient to share and explores the concern instead of dismissing it.
2. Facial expression, posture/body position, eye contact, tone of voice, gestures, use of touch, physical distance (any three).
3. Restatement repeats the patient's message to show it was heard; clarification asks the patient to expand or explain a vague statement so it is understood correctly.
4. Silence gives the patient time to organize thoughts, encourages them to continue, and lets the nurse observe.
5. Situation, Background, Assessment, Recommendation.
6. Family members may filter, mistranslate, or have their own agenda, and using them can breach confidentiality; professional interpreters provide accurate, confidential translation — follow facility policy on interpreter services.

</details>

## Related Topics

- Previous: [Critical Thinking in Assessment](01-critical-thinking-in-assessment.md)
- Next: [Health History](03-health-history.md)
- Related: [Comprehensive Health Assessment and Physical Examination chapter overview](../README.md)
