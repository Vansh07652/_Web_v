---
title: "Preoperative Nursing Priorities"
subject: "Nursing"
...
> **Chapter:** [Chapter 25: Preoperative Care](../README.md)  
> **Topic:** 2  
> **Source structure:** OpenStax public textbook outline

## Overview

On the day of surgery, the patient moves through the preoperative (holding) area, and the nurse's priorities shift from planning to execution. The preop nurse is the last line of defense before anesthesia: the person who verifies that the right patient, with the right procedure, on the right site, is ready and safe to go to the operating room. The work is a series of verifications — identity and procedure match the orders and consent; the surgical site is marked when required; NPO and medication instructions were followed; allergies are known and flagged; baseline vital signs and assessment are complete; jewelry, dentures, and prosthetics are handled per policy; and the patient and family understand what is about to happen.
...
|---|---|---|
| Two identifiers | Two independent pieces of patient identity (e.g., name + date of birth) | Prevents wrong-patient errors |
| Site marking | The surgical site marked (often with a signature) by the person performing the procedure | Prevents wrong-site surgery |
| Time-out | A final pause where the whole team confirms patient, procedure, site, and critical facts | The last structured safety check before the procedure |
| NPO | "Nothing by mouth" — the fasting instructions for anesthesia | Eating or drinking too close to anesthesia risks aspiration |
| Never event | A serious, preventable error (e.g., wrong-site surgery) | Must never happen; verification exists to stop it |
| Handoff | Structured transfer of patient information between teams | Prevents information loss at the OR door |
...
|---|---|---|
| Preop checklist review | The surgical time-out | The checklist is completed by the nurse in the preop area; the time-out is the team's final pause, with everyone present, just before the procedure |
| "Patient said they fasted" | Verified NPO status | The nurse confirms the *actual* last intake; a patient's assumption ("just a little is fine") is not compliance |
...
| Removing all personal items | Following facility/anesthesia policy | Some items (e.g., a hearing aid needed to communicate) may stay per anesthesia direction — know the policy and ask |
| Nurse deciding to cancel | Provider deciding to cancel | The nurse reports discrepancies; the surgeon/anesthesia provider makes the cancel-or-proceed decision |
...
1. The procedure as written in the signed consent, as described by the patient in their own words, and as ordered — all must match (with correct identity and site marking when required).
2. Report it to the anesthesia provider, who decides whether to delay or cancel. The nurse does not proceed quietly or decide independently, and must re-educate the patient and family about the plan.
3. Dentures and loose dental work are airway hazards under anesthesia, and jewelry can injure skin or interfere with equipment; removal rules follow facility and anesthesia policy, and exceptions (e.g., hearing aids) are made deliberately with the team.
4. The checklist is the nurse's day-of-surgery verification completed in the preop area; the time-out is the team's final, spoken confirmation of patient, procedure, site, and critical facts immediately before the procedure begins.
5. Identity/verification status, baseline vital signs and assessment, allergies, last NPO and medications taken or given, personal items secured, and any concerns — plus family communication plans.

</details>

## Related Topics

- Previous: [Preadmission Assessment and Education](01-preadmission-assessment-and-education.md)
- Next: [Preoperative Nursing Care Plan](03-preoperative-nursing-care-plan.md)
- Related: [Special Preoperative Considerations](04-special-preoperative-considerations.md) · [Preoperative Care chapter overview](../README.md)
