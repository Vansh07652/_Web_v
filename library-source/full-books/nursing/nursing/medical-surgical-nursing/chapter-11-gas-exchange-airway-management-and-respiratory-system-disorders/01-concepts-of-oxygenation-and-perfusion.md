---
title: "Concepts of Oxygenation and Perfusion"
subject: "Nursing"
...
> **Chapter:** [Chapter 11: Gas Exchange, Airway Management, and Respiratory System Disorders](../README.md)  
> **Topic:** 1  
> **Source structure:** OpenStax public textbook outline

## Overview

Every cell in the body needs a continuous supply of oxygen and a way to remove carbon dioxide. Getting oxygen from the air into a cell is not a single step — it is a chain. **Ventilation** moves air in and out of the lungs. **Gas exchange (diffusion)** moves oxygen from the air sacs (alveoli) into the blood and carbon dioxide out of the blood into the air. **Transport** carries oxygen through the bloodstream, mostly bound to hemoglobin inside red blood cells. **Perfusion** delivers that blood to the tissues, where the oxygen is unloaded for cells to use. If any link in the chain fails — a blocked airway, a collapsed lung region, low hemoglobin, a weak heart, or narrowed vessels — the tissues downstream do not get what they need.
...
The balance between ventilation (V) and perfusion (Q) is called the V/Q ratio. Two classic mismatches matter most. A **shunt** is blood flowing past alveoli that are not ventilated (for example, collapsed or fluid-filled lung regions) — deoxygenated blood returns to the left heart without picking up oxygen. **Dead space** is ventilation of alveoli that are not perfused (for example, a pulmonary embolus blocking blood flow) — air moves in and out, but no gas exchange happens. Most real-world lung disease produces a mixture of both.
...
|---|---|---|
| Ventilation | Movement of air in and out of the lungs | Delivers fresh oxygen and removes CO₂; fails with airway or breathing-muscle problems |
| Diffusion | Movement of oxygen and CO₂ across the alveolar–capillary membrane | The actual gas-exchange step; impaired by thick or damaged membranes and reduced surface area |
| Perfusion | Delivery of blood to the capillary beds | Without blood flow, oxygen cannot reach tissues even when lungs and hemoglobin are fine |
| V/Q ratio | The match between ventilation and blood flow in the lungs | Mismatch is the mechanism behind most hypoxemia in lung disease |
| Shunt | Blood flowing past unventilated alveoli | Deoxygenated blood returns to the body without picking up oxygen |
| Dead space | Ventilation of alveoli with no blood flow | Wasted ventilation — air moves but no gas exchange occurs |
| Hemoglobin | The oxygen-carrying protein inside red blood cells | Carries the great majority of oxygen; its amount and condition set transport capacity |
| SpO₂ | Pulse oximetry estimate of hemoglobin oxygen saturation | A quick, continuous oxygen check — but it cannot measure CO₂, pH, or dissolved oxygen issues |
| Hypoxemia | Low oxygen in the arterial blood | The blood-level problem; tissue-level oxygen shortage is called hypoxia |
...
1. List the links in the oxygenation chain in order.
2. What is the difference between a shunt and dead space?
3. How does anemia cause hypoxia even when the lungs are healthy?
4. Which direction does the oxyhemoglobin curve shift with fever and acidosis, and what does that do for tissues?
5. Why is cyanosis unreliable as a sign of hypoxemia?
6. In the two-person example, which person's lung problem produces a shunt, and which produces dead space?

<details>
<summary>Show answers</summary>

1. Ventilation (air in/out) → diffusion (gas exchange across the alveolar–capillary membrane) → transport (oxygen carried by hemoglobin in the blood) → perfusion (blood delivered to tissues) → cellular use.
2. A shunt is perfusion without ventilation — blood flows past alveoli that cannot exchange gas. Dead space is ventilation without perfusion — air reaches alveoli with no blood flow to pick up oxygen.
3. Hemoglobin is the transport vehicle for most oxygen. With anemia there are fewer vehicles, so even perfectly functioning lungs load less oxygen into the blood, and tissues get less.
4. Fever and acidosis shift the curve to the right — hemoglobin releases oxygen more easily, which helps hypoxic tissues get more oxygen.
5. Cyanosis is a late sign of hypoxemia, can be masked or unreliable in people with anemia or darker skin, and depends on the amount of unoxygenated hemoglobin in the blood — a person can be severely hypoxemic with normal-looking color.
6. Person A's pneumonia produces a shunt (fluid-filled, unventilated alveoli that still receive blood); Person B's pulmonary embolism produces dead space (ventilated alveoli whose blood supply is blocked).
...
- Next: [Upper and Lower Respiratory Assessment](02-upper-and-lower-respiratory-assessment.md)
- Related: [Chapter 11 overview](../README.md) · [Acid-Base Imbalance](../chapter-10-fluid-electrolyte-and-acid-base-imbalances/04-acid-base-imbalance.md) (ventilation is the body's CO₂ removal system)
